...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SocialPage.douban'
        db.add_column(u'my_resume_socialpage', 'douban',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=80),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SocialPage.douban'
        db.delete_column(u'my_resume_socialpage', 'douban')
    ...
    models = {
        ...
        u'my_resume.resume': {
            ...
            'resume_id': ('django.db.models.fields.CharField', [], {'default': "'54b8b4d68230db3903ed7f6b'", 'max_length': '50'}),
