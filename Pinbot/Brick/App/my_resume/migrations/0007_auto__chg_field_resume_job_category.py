...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Resume.job_category'
        db.alter_column(u'my_resume_resume', 'job_category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['system.PositionCategory'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'Resume.job_category'
        db.alter_column(u'my_resume_resume', 'job_category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['system.PositionCategory'], null=True))
    ...
    models = {
        ...
        u'my_resume.resume': {
            ...
            'resume_id': ('django.db.models.fields.CharField', [], {'default': "'54d03f5a8230db61486da080'", 'max_length': '50'}),
