...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SearchTag.company_domains'
        db.add_column(u'my_resume_searchtag', 'company_domains',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SearchTag.company_domains'
        db.delete_column(u'my_resume_searchtag', 'company_domains')
    ...
    models = {
        ...
        u'my_resume.searchtag': {
            ...
            'company_domains': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200'}),
            'degree': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '20'}),
