...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ResumePreferField'
        db.create_table(u'my_resume_resumepreferfield', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(related_name='category_prefer_fields', to=orm['jobs.CompanyCategory'])),
            ('resume', self.gf('django.db.models.fields.related.ForeignKey')(related_name='prefer_fields', to=orm['my_resume.Resume'])),
        ))
        db.send_create_signal(u'my_resume', ['ResumePreferField'])


    def backwards(self, orm):
        # Deleting model 'ResumePreferField'
        db.delete_table(u'my_resume_resumepreferfield')
    ...
    models = {
        ...
        u'my_resume.resumepreferfield': {
            'Meta': {'object_name': 'ResumePreferField'},
            'category': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'category_prefer_fields'", 'to': u"orm['jobs.CompanyCategory']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'resume': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'prefer_fields'", 'to': u"orm['my_resume.Resume']"})
        },
        ...
        u'my_resume.socialpage': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'linkedin': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '80'}),
