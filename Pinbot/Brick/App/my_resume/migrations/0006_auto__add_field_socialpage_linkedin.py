...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SocialPage.linkedin'
        db.add_column(u'my_resume_socialpage', 'linkedin',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=80),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SocialPage.linkedin'
        db.delete_column(u'my_resume_socialpage', 'linkedin')
    ...
    models = {
        ...
        u'my_resume.resume': {
            ...
            'resume_id': ('django.db.models.fields.CharField', [], {'default': "'54d01c098230db5272484b55'", 'max_length': '50'}),
