...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SearchTag.citys'
        db.add_column(u'my_resume_searchtag', 'citys',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=80),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SearchTag.citys'
        db.delete_column(u'my_resume_searchtag', 'citys')
    ...
    models = {
        ...
        u'my_resume.resume': {
            ...
            'resume_id': ('django.db.models.fields.CharField', [], {'default': "'54cc722a8230db397879ce63'", 'max_length': '50'}),
