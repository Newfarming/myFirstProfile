...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Resume.salary_lowest'
        db.add_column(u'my_resume_resume', 'salary_lowest',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Resume.salary_lowest'
        db.delete_column(u'my_resume_resume', 'salary_lowest')
