...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'my_resume_searchtag', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('resume', self.gf('django.db.models.fields.related.ForeignKey')(related_name='search_tags', to=orm['my_resume.Resume'])),
            ('work_years', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'my_resume', ['SearchTag'])


    def backwards(self, orm):
        # Deleting model 'SearchTag'
        db.delete_table(u'my_resume_searchtag')
    ...
    models = {
        ...
        u'my_resume.resume': {
            ...
            'resume_id': ('django.db.models.fields.CharField', [], {'default': "'54c7530f8230db833184e890'", 'max_length': '50'}),
