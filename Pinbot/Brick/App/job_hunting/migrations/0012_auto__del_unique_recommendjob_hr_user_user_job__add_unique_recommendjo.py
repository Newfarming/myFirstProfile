...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'RecommendJob', fields ['hr_user', 'user', 'job']
        db.delete_unique(u'job_hunting_recommendjob', ['hr_user_id', 'user_id', 'job_id'])

        # Adding unique constraint on 'RecommendJob', fields ['search_tag', 'hr_user', 'user', 'job']
        db.create_unique(u'job_hunting_recommendjob', ['search_tag_id', 'hr_user_id', 'user_id', 'job_id'])

        # Adding unique constraint on 'CompanyCardJob', fields ['hr_user', 'user', 'job']
        db.create_unique(u'job_hunting_companycardjob', ['hr_user_id', 'user_id', 'job_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'CompanyCardJob', fields ['hr_user', 'user', 'job']
        db.delete_unique(u'job_hunting_companycardjob', ['hr_user_id', 'user_id', 'job_id'])

        # Removing unique constraint on 'RecommendJob', fields ['search_tag', 'hr_user', 'user', 'job']
        db.delete_unique(u'job_hunting_recommendjob', ['search_tag_id', 'hr_user_id', 'user_id', 'job_id'])

        # Adding unique constraint on 'RecommendJob', fields ['hr_user', 'user', 'job']
        db.create_unique(u'job_hunting_recommendjob', ['hr_user_id', 'user_id', 'job_id'])
    ...
    models = {
        ...
        'feed.feed': {
            ...
            'delete_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 1, 0, 0)'}),
            ...
            'feed_expire_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 9, 0, 0)'}),
            ...
            'last_click_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 1, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'my_resume.resume': {
            ...
            'resume_id': ('django.db.models.fields.CharField', [], {'default': "'54cdf4c88230db0d316adfb6'", 'max_length': '50'}),
