...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'JobManage'
        db.delete_table(u'job_hunting_jobmanage')

        # Adding field 'RecommendJob.hr_user'
        db.add_column(u'job_hunting_recommendjob', 'hr_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='receive_jobs', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'RecommendJob.company_delete'
        db.add_column(u'job_hunting_recommendjob', 'company_delete',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'RecommendJob.reco_index'
        db.add_column(u'job_hunting_recommendjob', 'reco_index',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Adding model 'JobManage'
        db.create_table(u'job_hunting_jobmanage', (
            ('company_action_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('resume', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['my_resume.Resume'])),
            ('company_delete', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('job', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['feed.Feed'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_job_manage', to=orm['auth.User'])),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('action_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('hr_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='hr_job_manage', to=orm['auth.User'])),
            ('action', self.gf('django.db.models.fields.CharField')(default='', max_length=30)),
            ('delete', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'job_hunting', ['JobManage'])

        # Deleting field 'RecommendJob.hr_user'
        db.delete_column(u'job_hunting_recommendjob', 'hr_user_id')

        # Deleting field 'RecommendJob.company_delete'
        db.delete_column(u'job_hunting_recommendjob', 'company_delete')

        # Deleting field 'RecommendJob.reco_index'
        db.delete_column(u'job_hunting_recommendjob', 'reco_index')
    ...
    models = {
        ...
        'feed.feed': {
            ...
            'bind_job': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['jobs.Job']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'delete_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 28, 0, 0)'}),
            ...
            'feed_expire_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 5, 0, 0)'}),
            ...
            'last_click_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 28, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'job_hunting.companycardjob': {
            'Meta': {'object_name': 'CompanyCardJob'},
        ...
        u'job_hunting.recommendjob': {
            ...
            'reco_index': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
        ...
        u'jobs.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 28, 0, 0)'}),
        ...
        u'my_resume.resume': {
            ...
            'resume_id': ('django.db.models.fields.CharField', [], {'default': "'54c84e658230db1da1b29753'", 'max_length': '50'}),
