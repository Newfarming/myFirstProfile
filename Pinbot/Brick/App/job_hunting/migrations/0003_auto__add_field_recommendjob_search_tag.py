...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RecommendJob.search_tag'
        db.add_column(u'job_hunting_recommendjob', 'search_tag',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['my_resume.SearchTag'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RecommendJob.search_tag'
        db.delete_column(u'job_hunting_recommendjob', 'search_tag_id')
    ...
    models = {
        ...
        u'my_resume.resume': {
            ...
            'resume_id': ('django.db.models.fields.CharField', [], {'default': "'54c754128230db841f7b8517'", 'max_length': '50'}),
