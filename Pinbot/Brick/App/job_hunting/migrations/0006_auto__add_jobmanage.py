...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'feed.feed': {
            ...
            'delete_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 27, 0, 0)'}),
            ...
            'feed_expire_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 4, 0, 0)'}),
            ...
            'last_click_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 27, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'job_hunting.jobmanage': {
            'Meta': {'object_name': 'JobManage'},
            ...
            'delete': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'hr_user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'hr_job_manage'", 'to': u"orm['auth.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'user_job_manage'", 'to': u"orm['auth.User']"})
        },
        ...
        u'my_resume.resume': {
            ...
            'resume_id': ('django.db.models.fields.CharField', [], {'default': "'54c78c788230db19f17d2907'", 'max_length': '50'}),
