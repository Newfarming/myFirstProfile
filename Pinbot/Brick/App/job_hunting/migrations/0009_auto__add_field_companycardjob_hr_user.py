...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyCardJob.hr_user'
        db.add_column(u'job_hunting_companycardjob', 'hr_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='send_card_jobs', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompanyCardJob.hr_user'
        db.delete_column(u'job_hunting_companycardjob', 'hr_user_id')
    ...
    models = {
        ...
        'feed.feed': {
            ...
            'delete_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 29, 0, 0)'}),
            ...
            'feed_expire_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 6, 0, 0)'}),
            ...
            'last_click_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 29, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'my_resume.resume': {
            ...
            'resume_id': ('django.db.models.fields.CharField', [], {'default': "'54c9ed918230dbb9e84d81ec'", 'max_length': '50'}),
