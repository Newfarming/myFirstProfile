...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CompanyCardJob'
        db.create_table(u'job_hunting_companycardjob', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('job', self.gf('django.db.models.fields.related.ForeignKey')(related_name='send_jobs', to=orm['jobs.Job'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='card_jobs', to=orm['auth.User'])),
            ('send_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('status', self.gf('django.db.models.fields.CharField')(default='waiting', max_length=30)),
        ...
        db.send_create_signal(u'job_hunting', ['CompanyCardJob'])


    def backwards(self, orm):
        # Deleting model 'CompanyCardJob'
        db.delete_table(u'job_hunting_companycardjob')
    ...
    models = {
        ...
        u'my_resume.resume': {
            ...
            'resume_id': ('django.db.models.fields.CharField', [], {'default': "'54c73d9b8230db772c736429'", 'max_length': '50'}),
