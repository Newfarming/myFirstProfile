...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyCardJob.token'
        db.add_column(u'job_hunting_companycardjob', 'token',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=70),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompanyCardJob.token'
        db.delete_column(u'job_hunting_companycardjob', 'token')
    ...
    models = {
        ...
        u'my_resume.resume': {
            ...
            'resume_id': ('django.db.models.fields.CharField', [], {'default': "'54ca0c478230dbc5c95a7bb3'", 'max_length': '50'}),
