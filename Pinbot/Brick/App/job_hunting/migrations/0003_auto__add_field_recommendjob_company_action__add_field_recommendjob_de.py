...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RecommendJob.company_action'
        db.add_column(u'job_hunting_recommendjob', 'company_action',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30),
                      keep_default=False)

        # Adding field 'RecommendJob.delete'
        db.add_column(u'job_hunting_recommendjob', 'delete',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RecommendJob.company_action'
        db.delete_column(u'job_hunting_recommendjob', 'company_action')

        # Deleting field 'RecommendJob.delete'
        db.delete_column(u'job_hunting_recommendjob', 'delete')
    ...
    models = {
        ...
        u'my_resume.resume': {
            ...
            'resume_id': ('django.db.models.fields.CharField', [], {'default': "'54c730168230db6ea998c8fd'", 'max_length': '50'}),
