...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'RecommendJob', fields ['action_time']
        db.create_index(u'job_hunting_recommendjob', ['action_time'])

        # Adding index on 'RecommendJob', fields ['company_action_time']
        db.create_index(u'job_hunting_recommendjob', ['company_action_time'])

        # Adding index on 'RecommendJob', fields ['reco_time']
        db.create_index(u'job_hunting_recommendjob', ['reco_time'])


    def backwards(self, orm):
        # Removing index on 'RecommendJob', fields ['reco_time']
        db.delete_index(u'job_hunting_recommendjob', ['reco_time'])

        # Removing index on 'RecommendJob', fields ['company_action_time']
        db.delete_index(u'job_hunting_recommendjob', ['company_action_time'])

        # Removing index on 'RecommendJob', fields ['action_time']
        db.delete_index(u'job_hunting_recommendjob', ['action_time'])
    ...
    models = {
        ...
        'feed.feed': {
            ...
            'delete_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 2, 0, 0)'}),
            ...
            'feed_expire_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 10, 0, 0)'}),
            ...
            'last_click_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 2, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'job_hunting.recommendjob': {
            ...
            'action_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            'company_action': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '30'}),
            'company_action_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
        ...
        u'jobs.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 2, 0, 0)'}),
