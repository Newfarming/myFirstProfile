...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RecommendJob'
        db.create_table(u'job_hunting_recommendjob', (
            ...
            ('reco_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('read_status', self.gf('django.db.models.fields.CharField')(default='unread', max_length=10)),
            ('action', self.gf('django.db.models.fields.CharField')(default='', max_length=30)),
        ))
        db.send_create_signal(u'job_hunting', ['RecommendJob'])

        # Adding model 'RecommendConf'
        db.create_table(u'job_hunting_recommendconf', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('position', self.gf('django.db.models.fields.CharField')(default='', max_length=30)),
        ))
        db.send_create_signal(u'job_hunting', ['RecommendConf'])

        # Adding model 'JobMessage'
        db.create_table(u'job_hunting_jobmessage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('message', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('create_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['job_hunting.JobMessage'], null=True, blank=True)),
        ))
        db.send_create_signal(u'job_hunting', ['JobMessage'])


    def backwards(self, orm):
        # Deleting model 'RecommendJob'
        db.delete_table(u'job_hunting_recommendjob')

        # Deleting model 'RecommendConf'
        db.delete_table(u'job_hunting_recommendconf')

        # Deleting model 'JobMessage'
        db.delete_table(u'job_hunting_jobmessage')
    ...
    models = {
        ...
        'feed.feed': {
            ...
            'delete_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 20, 0, 0)'}),
            ...
            'feed_expire_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 28, 0, 0)'}),
            ...
            'last_click_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 20, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'my_resume.resume': {
            ...
            'resume_id': ('django.db.models.fields.CharField', [], {'default': "'54be3de28230db616972542e'", 'max_length': '50'}),
