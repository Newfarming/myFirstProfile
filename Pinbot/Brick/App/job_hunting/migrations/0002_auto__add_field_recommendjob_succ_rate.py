...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RecommendJob.succ_rate'
        db.add_column(u'job_hunting_recommendjob', 'succ_rate',
                      self.gf('django.db.models.fields.FloatField')(default=66.6),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RecommendJob.succ_rate'
        db.delete_column(u'job_hunting_recommendjob', 'succ_rate')
    ...
    models = {
        ...
        u'my_resume.resume': {
            ...
            'resume_id': ('django.db.models.fields.CharField', [], {'default': "'54be3e508230db62199ef136'", 'max_length': '50'}),
