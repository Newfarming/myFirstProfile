...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RecommendJob.display'
        db.add_column(u'job_hunting_recommendjob', 'display',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'RecommendJob.display'
        db.delete_column(u'job_hunting_recommendjob', 'display')
    ...
    models = {
        ...
        u'job_hunting.recommendjob': {
            'Meta': {'unique_together': "(('hr_user', 'user', 'job'),)", 'object_name': 'RecommendJob'},
        ...
        u'my_resume.resume': {
            ...
            'resume_id': ('django.db.models.fields.CharField', [], {'default': "'54cdbddd8230db7d0810ac09'", 'max_length': '50'}),
