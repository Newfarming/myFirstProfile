...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RecommendJob.action_time'
        db.add_column(u'job_hunting_recommendjob', 'action_time',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2015, 1, 27, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'RecommendJob.company_action_time'
        db.add_column(u'job_hunting_recommendjob', 'company_action_time',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2015, 1, 27, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RecommendJob.action_time'
        db.delete_column(u'job_hunting_recommendjob', 'action_time')

        # Deleting field 'RecommendJob.company_action_time'
        db.delete_column(u'job_hunting_recommendjob', 'company_action_time')
    ...
    models = {
        ...
        u'my_resume.resume': {
            ...
            'resume_id': ('django.db.models.fields.CharField', [], {'default': "'54c731ab8230db6fc17608e2'", 'max_length': '50'}),
