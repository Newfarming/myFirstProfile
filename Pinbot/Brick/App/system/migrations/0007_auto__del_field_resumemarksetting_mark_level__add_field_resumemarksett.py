...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ResumeMarkSetting.mark_level'
        db.delete_column(u'system_resumemarksetting', 'mark_level')

        # Adding field 'ResumeMarkSetting.change'
        db.add_column(u'system_resumemarksetting', 'change',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'ResumeMarkSetting.parent'
        db.add_column(u'system_resumemarksetting', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='mark_choices', null=True, to=orm['system.ResumeMarkSetting']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ResumeMarkSetting.mark_level'
        db.add_column(u'system_resumemarksetting', 'mark_level',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Deleting field 'ResumeMarkSetting.change'
        db.delete_column(u'system_resumemarksetting', 'change')
