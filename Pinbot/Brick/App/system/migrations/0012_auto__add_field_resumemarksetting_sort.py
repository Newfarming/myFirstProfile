...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResumeMarkSetting.sort'
        db.add_column(u'system_resumemarksetting', 'sort',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ResumeMarkSetting.sort'
        db.delete_column(u'system_resumemarksetting', 'sort')
