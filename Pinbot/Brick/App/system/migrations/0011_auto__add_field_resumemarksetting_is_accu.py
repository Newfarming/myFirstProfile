...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResumeMarkSetting.is_accu'
        db.add_column(u'system_resumemarksetting', 'is_accu',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ResumeMarkSetting.is_accu'
        db.delete_column(u'system_resumemarksetting', 'is_accu')
