...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ResumeMarkRelation'
        db.create_table(u'system_resumemarkrelation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='child_marks', null=True, to=orm['system.ResumeMarkRelation'])),
            ('mark', self.gf('django.db.models.fields.related.ForeignKey')(related_name='mark_relation', to=orm['system.ResumeMarkSetting'])),
        ))
        db.send_create_signal(u'system', ['ResumeMarkRelation'])


    def backwards(self, orm):
        # Deleting model 'ResumeMarkRelation'
        db.delete_table(u'system_resumemarkrelation')
    ...
    models = {
        ...
        u'system.resumemarkrelation': {
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'child_marks'", 'null': 'True', 'to': u"orm['system.ResumeMarkRelation']"})
        },
