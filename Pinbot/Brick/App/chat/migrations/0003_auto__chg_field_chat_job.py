...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'chat_chat', 'job_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['jobs.Job']))

    def backwards(self, orm):

        # Changing field 'Chat.job'
        db.alter_column(u'chat_chat', 'job_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['feed.Feed']))
    ...
    models = {
        ...
        u'chat.chat': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'job': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'job_chat'", 'to': u"orm['jobs.Job']"}),
        ...
        u'my_resume.resume': {
            ...
            'resume_id': ('django.db.models.fields.CharField', [], {'default': "'54c366838230dbea4b83a83e'", 'max_length': '50'}),
