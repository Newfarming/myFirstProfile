...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ChatMessage.sender_read'
        db.add_column(u'chat_chatmessage', 'sender_read',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ChatMessage.receiver_read'
        db.add_column(u'chat_chatmessage', 'receiver_read',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ChatMessage.sender_read'
        db.delete_column(u'chat_chatmessage', 'sender_read')

        # Deleting field 'ChatMessage.receiver_read'
        db.delete_column(u'chat_chatmessage', 'receiver_read')
    ...
    models = {
        ...
        u'my_resume.resume': {
            ...
            'resume_id': ('django.db.models.fields.CharField', [], {'default': "'54c30c858230dbc28c977f6c'", 'max_length': '50'}),
