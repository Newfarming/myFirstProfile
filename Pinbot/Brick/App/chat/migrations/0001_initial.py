...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Chat'
        db.create_table(u'chat_chat', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('job_hunter', self.gf('django.db.models.fields.related.ForeignKey')(related_name='hunter_chat', to=orm['auth.User'])),
            ('hr', self.gf('django.db.models.fields.related.ForeignKey')(related_name='hr_chat', to=orm['auth.User'])),
            ('job', self.gf('django.db.models.fields.related.ForeignKey')(related_name='job_chat', to=orm['feed.Feed'])),
            ('resume', self.gf('django.db.models.fields.related.ForeignKey')(related_name='resume_chat', to=orm['my_resume.Resume'])),
            ('create_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'chat', ['Chat'])

        # Adding model 'ChatMessage'
        db.create_table(u'chat_chatmessage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('chat', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chat.Chat'])),
            ('sender', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sender_msgs', to=orm['auth.User'])),
            ('receiver', self.gf('django.db.models.fields.related.ForeignKey')(related_name='receiver_msgs', to=orm['auth.User'])),
            ...
            ('sender_delete', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('receiver_delete', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'chat', ['ChatMessage'])


    def backwards(self, orm):
        # Deleting model 'Chat'
        db.delete_table(u'chat_chat')

        # Deleting model 'ChatMessage'
        db.delete_table(u'chat_chatmessage')
    ...
    models = {
        ...
        u'chat.chat': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'job': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'job_chat'", 'to': "orm['feed.Feed']"}),
        ...
        'feed.feed': {
            ...
            'delete_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 24, 0, 0)'}),
            ...
            'feed_expire_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 1, 0, 0)'}),
            ...
            'last_click_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 24, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'jobs.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 24, 0, 0)'}),
        ...
        u'my_resume.resume': {
            ...
            'resume_id': ('django.db.models.fields.CharField', [], {'default': "'54c30c638230dbc22cf0810c'", 'max_length': '50'}),
