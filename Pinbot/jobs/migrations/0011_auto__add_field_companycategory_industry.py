...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyCategory.industry'
        db.add_column(u'jobs_companycategory', 'industry',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='company_category_industry', to=orm['jobs.Industry']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompanyCategory.industry'
        db.delete_column(u'jobs_companycategory', 'industry_id')
    ...
    models = {
        ...
        u'jobs.companycategory': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'industry': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'company_category_industry'", 'to': u"orm['jobs.Industry']"}),
