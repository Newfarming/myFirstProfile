...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserFavourCompany'
        db.create_table(u'jobs_userfavourcompany', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('company', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_favours', to=orm['jobs.Company'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='favour_companys', to=orm['auth.User'])),
            ('time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'jobs', ['UserFavourCompany'])

        # Adding field 'Company.favour_count'
        db.add_column(u'jobs_company', 'favour_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'UserFavourCompany'
        db.delete_table(u'jobs_userfavourcompany')

        # Deleting field 'Company.favour_count'
        db.delete_column(u'jobs_company', 'favour_count')
    ...
    models = {
        ...
        u'jobs.sendcompanycard': {
            ...
            'feed_id': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100'}),
            'feedback_status': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'feedback_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 2, 0, 0)'}),
            ...
            'send_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 2, 0, 0)'}),
