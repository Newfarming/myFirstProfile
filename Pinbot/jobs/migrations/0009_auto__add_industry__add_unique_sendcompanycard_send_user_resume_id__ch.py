...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'jobs_industry', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('industry_name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('code_name', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal(u'jobs', ['Industry'])

        # Adding unique constraint on 'SendCompanyCard', fields ['send_user', 'resume_id']
        db.create_unique(u'jobs_sendcompanycard', ['send_user_id', 'resume_id'])


        # Changing field 'Company.url'
        db.alter_column(u'jobs_company', 'url', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Company.core_team'
        db.alter_column(u'jobs_company', 'core_team', self.gf('django.db.models.fields.CharField')(max_length=1000))

        # Changing field 'Company.company_stage'
        db.alter_column(u'jobs_company', 'company_stage', self.gf('django.db.models.fields.CharField')(max_length=1000))

        # Changing field 'Company.product_url'
        db.alter_column(u'jobs_company', 'product_url', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Company.key_points'
        db.alter_column(u'jobs_company', 'key_points', self.gf('django.db.models.fields.CharField')(max_length=1000))

        # Changing field 'Company.desc'
        db.alter_column(u'jobs_company', 'desc', self.gf('django.db.models.fields.CharField')(max_length=1000))

    def backwards(self, orm):
        # Removing unique constraint on 'SendCompanyCard', fields ['send_user', 'resume_id']
        db.delete_unique(u'jobs_sendcompanycard', ['send_user_id', 'resume_id'])

        # Deleting model 'Industry'
        db.delete_table(u'jobs_industry')


        # Changing field 'Company.url'
        db.alter_column(u'jobs_company', 'url', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Company.core_team'
        db.alter_column(u'jobs_company', 'core_team', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))

        # Changing field 'Company.company_stage'
        db.alter_column(u'jobs_company', 'company_stage', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))

        # Changing field 'Company.product_url'
        db.alter_column(u'jobs_company', 'product_url', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Company.key_points'
        db.alter_column(u'jobs_company', 'key_points', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))

        # Changing field 'Company.desc'
        db.alter_column(u'jobs_company', 'desc', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))
    ...
    models = {
        ...
        u'jobs.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 3, 14, 0, 0)'}),
        ...
        u'jobs.industry': {
            ...
            'code_name': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'industry_name': ('django.db.models.fields.CharField', [], {'max_length': '30'})
        },
        u'jobs.job': {
        ...
        u'jobs.sendcompanycard': {
            ...
            'feedback_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 3, 14, 0, 0)'}),
            ...
            'send_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 3, 14, 0, 0)'}),
