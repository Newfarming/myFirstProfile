...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SendCompanyCard.feed_id'
        db.add_column(u'jobs_sendcompanycard', 'feed_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SendCompanyCard.feed_id'
        db.delete_column(u'jobs_sendcompanycard', 'feed_id')
