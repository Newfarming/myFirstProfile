...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Company.pinbot_recommand'
        db.delete_column(u'jobs_company', 'pinbot_recommand')

        # Adding field 'Company.pinbot_recommend'
        db.add_column(u'jobs_company', 'pinbot_recommend',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=300),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Company.pinbot_recommand'
        db.add_column(u'jobs_company', 'pinbot_recommand',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=300),
                      keep_default=False)

        # Deleting field 'Company.pinbot_recommend'
        db.delete_column(u'jobs_company', 'pinbot_recommend')
    ...
    models = {
        ...
        u'jobs.sendcompanycard': {
            ...
            'feedback_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 4, 0, 0)'}),
            ...
            'send_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 4, 0, 0)'}),
