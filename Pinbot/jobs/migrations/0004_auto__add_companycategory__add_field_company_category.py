...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'jobs_companycategory', (
        ...
        db.send_create_signal(u'jobs', ['CompanyCategory'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'jobs_companycategory')
    ...
    models = {
        ...
        u'jobs.sendcompanycard': {
            ...
            'feedback_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 11, 0, 0)'}),
            ...
            'send_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 11, 0, 0)'}),
