...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Company.need_recommend'
        db.add_column(u'jobs_company', 'need_recommend',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Company.need_recommend'
        db.delete_column(u'jobs_company', 'need_recommend')
    ...
    models = {
        ...
        u'jobs.sendcompanycard': {
            ...
            'feedback_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 19, 0, 0)'}),
            ...
            'send_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 19, 0, 0)'}),
