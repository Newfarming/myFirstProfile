...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HistoryContactInfo'
        db.create_table(u'resumes_historycontactinfo', (
            ...
            ('add_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2016, 1, 26, 0, 0), null=True, blank=True)),
            ...
            ('contact_info', self.gf('django.db.models.fields.related.ForeignKey')(related_name='history_infos', to=orm['resumes.ContactInfoData'])),
            ('origin', self.gf('django.db.models.fields.IntegerField')(default=1, blank=True)),
        ))
        db.send_create_signal(u'resumes', ['HistoryContactInfo'])

        # Adding field 'ContactInfoData.update_time'
        db.add_column('resumes_contactinfo', 'update_time',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2016, 1, 26, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'ContactInfoData.origin'
        db.add_column('resumes_contactinfo', 'origin',
                      self.gf('django.db.models.fields.IntegerField')(default=1, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'HistoryContactInfo'
        db.delete_table(u'resumes_historycontactinfo')

        # Deleting field 'ContactInfoData.update_time'
        db.delete_column('resumes_contactinfo', 'update_time')

        # Deleting field 'ContactInfoData.origin'
        db.delete_column('resumes_contactinfo', 'origin')
    ...
    models = {
        ...
        u'resumes.contactinfodata': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 26, 0, 0)', 'null': 'True', 'blank': 'True'}),
