...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Comment.comment_time'
        db.alter_column('resumes_comment', 'comment_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
        # Adding index on 'Comment', fields ['resume_id']
        db.create_index('resumes_comment', ['resume_id'])


    def backwards(self, orm):
        # Removing index on 'Comment', fields ['resume_id']
        db.delete_index('resumes_comment', ['resume_id'])


        # Changing field 'Comment.comment_time'
        db.alter_column('resumes_comment', 'comment_time', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        u'resumes.contactinfodata': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 4, 0, 0)', 'null': 'True', 'blank': 'True'}),
