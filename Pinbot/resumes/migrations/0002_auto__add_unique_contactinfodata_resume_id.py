...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ContactInfoData', fields ['resume_id']
        db.create_unique('resumes_contactinfo', ['resumeID'])


    def backwards(self, orm):
        # Removing unique constraint on 'ContactInfoData', fields ['resume_id']
        db.delete_unique('resumes_contactinfo', ['resumeID'])
