...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ContactInfoData'
        db.create_table('resumes_contactinfo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('resume_id', self.gf('django.db.models.fields.CharField')(max_length=100, db_column='resumeID')),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('source', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('source_id', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, db_column='sourceID', blank=True)),
            ...
            ('qq', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('weibo', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('add_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 4, 28, 0, 0), null=True, blank=True)),
            ('identity_id', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, db_column='identityID', blank=True)),
            ('reported_num', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('status', self.gf('django.db.models.fields.CharField')(default='public', max_length=100)),
        ))
        db.send_create_signal(u'resumes', ['ContactInfoData'])

        # Adding model 'Comment'
        db.create_table('resumes_comment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('type', self.gf('django.db.models.fields.IntegerField')(default=2)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('comment_obj_id', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ...
        db.send_create_signal(u'resumes', ['Comment'])

        # Adding model 'Tag'
        db.create_table(u'resumes_tag', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('resume_id', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('tag_obj_id', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('feed_id', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('type', self.gf('django.db.models.fields.IntegerField')(default=1, null=True, blank=True)),
            ('scope', self.gf('django.db.models.fields.CharField')(default='resume', max_length=100, null=True, blank=True)),
            ('add_time', self.gf('django.db.models.fields.DateTimeField')()),
            ('tag_content', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('status', self.gf('django.db.models.fields.CharField')(default='new', max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal(u'resumes', ['Tag'])

        # Adding model 'ResumeTag'
        db.create_table(u'resumes_resumetag', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('resume_id', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['resumes.Tag'])),
            ('tag_content', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('add_time', self.gf('django.db.models.fields.DateTimeField')()),
            ('status', self.gf('django.db.models.fields.CharField')(default='new', max_length=100)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
        ))
        db.send_create_signal(u'resumes', ['ResumeTag'])

        # Adding model 'UserWatchResume'
        db.create_table(u'resumes_userwatchresume', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('resume_id', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('feed_id', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ...
            ('has_contact', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('keywords', self.gf('django.db.models.fields.CharField')(default='', max_length=100)),
            ('feed_keywords', self.gf('django.db.models.fields.CharField')(default='', max_length=100)),
            ('analysis_id', self.gf('django.db.models.fields.CharField')(default='', max_length=100)),
        ))
        db.send_create_signal(u'resumes', ['UserWatchResume'])


    def backwards(self, orm):
        # Deleting model 'ContactInfoData'
        db.delete_table('resumes_contactinfo')

        # Deleting model 'Comment'
        db.delete_table('resumes_comment')

        # Deleting model 'Tag'
        db.delete_table(u'resumes_tag')

        # Deleting model 'ResumeTag'
        db.delete_table(u'resumes_resumetag')

        # Deleting model 'UserWatchResume'
        db.delete_table(u'resumes_userwatchresume')
    ...
    models = {
        ...
        u'resumes.contactinfodata': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 28, 0, 0)', 'null': 'True', 'blank': 'True'}),
