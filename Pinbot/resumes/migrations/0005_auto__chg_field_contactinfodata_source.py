...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ContactInfoData.source'
        db.alter_column('resumes_contactinfo', 'source', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'ContactInfoData.source'
        db.alter_column('resumes_contactinfo', 'source', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
    ...
    models = {
        ...
        u'resumes.contactinfodata': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 29, 0, 0)', 'null': 'True', 'blank': 'True'}),
