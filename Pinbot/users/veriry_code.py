...
class Code(object):
    ...
    def _get_worlds(self):
        ...
        读取默认的单词表
        """
        file_path = current_path + '/DjangoVerifyCode/worlds.list'
        f = open(file_path, 'r')
    ...
    def display(self):
        ...
        # 字体文件路径
        self.font_path = current_path + '/DjangoVerifyCode/timesbi.ttf'
        ...
        for i in range(random.randrange(1, 3)):
            ...
            draw.chord(xy, 0, 1400, fill=line_color)
