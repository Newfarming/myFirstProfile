...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'UserIndustry'
        db.delete_table(u'users_userindustry')

        # Adding model 'NewIndustryBookin'
        db.create_table(u'users_newindustrybookin', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_enlist', to=orm['users.UserProfile'])),
            ('type', self.gf('django.db.models.fields.IntegerField')()),
            ('add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'users', ['NewIndustryBookin'])


    def backwards(self, orm):
        # Adding model 'UserIndustry'
        db.create_table(u'users_userindustry', (
            ('company', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_company', to=orm['jobs.Company'])),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('industry_name', self.gf('django.db.models.fields.TextField')(max_length=200)),
        ))
        db.send_create_signal(u'users', ['UserIndustry'])

        # Deleting model 'NewIndustryBookin'
        db.delete_table(u'users_newindustrybookin')
    ...
    models = {
        ...
        u'users.newindustrybookin': {
            'Meta': {'object_name': 'NewIndustryBookin'},
            'add_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'type': ('django.db.models.fields.IntegerField', [], {}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'user_enlist'", 'to': u"orm['users.UserProfile']"})
        },
        u'users.staffcustomerassgin': {
            'Meta': {'object_name': 'StaffCustomerAssgin', 'db_table': "'report_staffcustomerassgin'"},
            'create_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 3, 14, 0, 0)'}),
        ...
        u'users.userprofile': {
            ...
            'area': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '30', 'blank': 'True'}),
            ...
            'recv_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50', 'blank': 'True'}),
            'recv_phone': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50', 'blank': 'True'}),
            ...
            'user_email': ('django.db.models.fields.EmailField', [], {'max_length': '80'})
        }
    }
