...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'users.userindustry': {
            'Meta': {'object_name': 'UserIndustry'},
            'company': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'user_company'", 'to': u"orm['jobs.Company']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'industry_name': ('django.db.models.fields.TextField', [], {'max_length': '200'})
        },
        u'users.usermailbox': {
