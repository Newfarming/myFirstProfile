...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.calc_level'
        db.add_column('users_userprofile', 'calc_level',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.calc_level'
        db.delete_column('users_userprofile', 'calc_level')
    ...
    models = {
        ...
        u'users.staffcustomerassgin': {
            ...
            'create_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 24, 0, 0)'}),
