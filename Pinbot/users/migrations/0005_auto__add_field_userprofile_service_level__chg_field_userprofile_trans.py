...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.service_level'
        db.add_column('users_userprofile', 'service_level',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


        # Changing field 'UserProfile.trans_time'
        db.alter_column('users_userprofile', 'trans_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):
        # Deleting field 'UserProfile.service_level'
        db.delete_column('users_userprofile', 'service_level')


        # Changing field 'UserProfile.trans_time'
        db.alter_column('users_userprofile', 'trans_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
    ...
    models = {
        ...
        u'users.staffcustomerassgin': {
            ...
            'create_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 26, 0, 0)'}),
        ...
        u'users.userprofile': {
            ...
            'service_level': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
