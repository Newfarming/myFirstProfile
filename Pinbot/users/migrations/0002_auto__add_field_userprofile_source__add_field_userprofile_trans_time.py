...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.source'
        db.add_column('users_userprofile', 'source',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'UserProfile.trans_time'
        db.add_column('users_userprofile', 'trans_time',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2015, 1, 28, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.source'
        db.delete_column('users_userprofile', 'source')

        # Deleting field 'UserProfile.trans_time'
        db.delete_column('users_userprofile', 'trans_time')
    ...
    models = {
        ...
        u'users.userprofile': {
            ...
            'trans_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
