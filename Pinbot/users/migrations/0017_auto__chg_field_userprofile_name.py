...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('users_userprofile', 'name', self.gf('django.db.models.fields.CharField')(max_length=80))

    def backwards(self, orm):

        # Changing field 'UserProfile.name'
        db.alter_column('users_userprofile', 'name', self.gf('django.db.models.fields.CharField')(max_length=30))
