...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.recv_phone'
        db.add_column('users_userprofile', 'recv_phone',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.recv_name'
        db.add_column('users_userprofile', 'recv_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.recv_phone'
        db.delete_column('users_userprofile', 'recv_phone')

        # Deleting field 'UserProfile.recv_name'
        db.delete_column('users_userprofile', 'recv_name')
    ...
    models = {
        ...
        u'users.staffcustomerassgin': {
            ...
            'create_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 13, 0, 0)'}),
