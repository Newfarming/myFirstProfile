...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserContactInfo'
        db.create_table(u'users_usercontactinfo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='contact_infos', to=orm['auth.User'])),
            ('user_email', self.gf('django.db.models.fields.EmailField')(max_length=60, null=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=40)),
            ('phone', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ))
        db.send_create_signal(u'users', ['UserContactInfo'])


    def backwards(self, orm):
        # Deleting model 'UserContactInfo'
        db.delete_table(u'users_usercontactinfo')
    ...
    models = {
        ...
        u'users.staffcustomerassgin': {
            ...
            'create_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 16, 0, 0)'}),
