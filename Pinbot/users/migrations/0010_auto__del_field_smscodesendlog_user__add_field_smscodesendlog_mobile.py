...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SmsCodeSendLog.user'
        db.delete_column(u'users_smscodesendlog', 'user_id')

        # Adding field 'SmsCodeSendLog.mobile'
        db.add_column(u'users_smscodesendlog', 'mobile',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'SmsCodeSendLog.user'
        raise RuntimeError("Cannot reverse this migration. 'SmsCodeSendLog.user' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'SmsCodeSendLog.user'
        db.add_column(u'users_smscodesendlog', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']),
                      keep_default=False)

        # Deleting field 'SmsCodeSendLog.mobile'
        db.delete_column(u'users_smscodesendlog', 'mobile')
    ...
    models = {
        ...
        u'users.smscodesendlog': {
            'Meta': {'object_name': 'SmsCodeSendLog'},
            'action_name': ('django.db.models.fields.CharField', [], {'default': "'Other'", 'max_length': '50'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_time': ('django.db.models.fields.DateTimeField', [], {}),
            'mobile': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255'})
        },
        u'users.staffcustomerassgin': {
            'Meta': {'object_name': 'StaffCustomerAssgin', 'db_table': "'report_staffcustomerassgin'"},
            'create_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 10, 19, 0, 0)'}),
