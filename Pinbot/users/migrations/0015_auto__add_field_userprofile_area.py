...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('users_userprofile', 'area',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('users_userprofile', 'area')
    ...
    models = {
        ...
        u'users.staffcustomerassgin': {
            ...
            'create_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 26, 0, 0)'}),
