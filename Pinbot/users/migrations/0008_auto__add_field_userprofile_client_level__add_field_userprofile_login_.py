...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.client_level'
        db.add_column('users_userprofile', 'client_level',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.login_days'
        db.add_column('users_userprofile', 'login_days',
                      self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.client_level'
        db.delete_column('users_userprofile', 'client_level')

        # Deleting field 'UserProfile.login_days'
        db.delete_column('users_userprofile', 'login_days')
    ...
    models = {
        ...
        u'users.staffcustomerassgin': {
            ...
            'create_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 30, 0, 0)'}),
