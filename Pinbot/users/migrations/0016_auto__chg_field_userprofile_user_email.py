...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.user_email'
        db.alter_column('users_userprofile', 'user_email', self.gf('django.db.models.fields.EmailField')(max_length=80))

    def backwards(self, orm):

        # Changing field 'UserProfile.user_email'
        db.alter_column('users_userprofile', 'user_email', self.gf('django.db.models.fields.EmailField')(max_length=30))
    ...
    models = {
        ...
        u'users.staffcustomerassgin': {
            ...
            'create_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 3, 11, 0, 0)'}),
