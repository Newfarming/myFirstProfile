...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserMarkLog.is_display'
        db.add_column(u'transaction_usermarklog', 'is_display',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'UserMarkLog.desc'
        db.alter_column(u'transaction_usermarklog', 'desc', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):
        # Deleting field 'UserMarkLog.is_display'
        db.delete_column(u'transaction_usermarklog', 'is_display')


        # Changing field 'UserMarkLog.desc'
        db.alter_column(u'transaction_usermarklog', 'desc', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    models = {
        ...
        u'transaction.userchargepackage': {
            ...
            'feed_end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2017, 3, 14, 0, 0)', 'db_index': 'True'}),
            ...
            'resume_end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2017, 3, 14, 0, 0)', 'db_index': 'True'}),
            'resume_package': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['pinbot_package.ResumePackge']", 'null': 'True', 'blank': 'True'}),
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 3, 14, 0, 0)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
        ...
        u'transaction.userresumefeedback': {
            ...
            'create_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 3, 14, 0, 0)', 'null': 'True', 'blank': 'True'}),
