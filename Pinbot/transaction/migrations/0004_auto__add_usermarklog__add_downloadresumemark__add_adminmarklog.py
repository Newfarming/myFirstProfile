...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserMarkLog'
        db.create_table(u'transaction_usermarklog', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('resume_mark', self.gf('django.db.models.fields.related.ForeignKey')(related_name='mark_logs', to=orm['transaction.DownloadResumeMark'])),
            ('mark_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('mark_status', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('desc', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'transaction', ['UserMarkLog'])

        # Adding model 'DownloadResumeMark'
        db.create_table(u'transaction_downloadresumemark', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('buy_record', self.gf('django.db.models.fields.related.OneToOneField')(related_name='resume_mark', unique=True, to=orm['transaction.ResumeBuyRecord'])),
            ('last_mark', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('mark_status', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('pay_status', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('mark_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('verify_status', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'transaction', ['DownloadResumeMark'])

        # Adding model 'AdminMarkLog'
        db.create_table(u'transaction_adminmarklog', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('resume_mark', self.gf('django.db.models.fields.related.ForeignKey')(related_name='admin_logs', to=orm['transaction.DownloadResumeMark'])),
        ...
        db.send_create_signal(u'transaction', ['AdminMarkLog'])


    def backwards(self, orm):
        # Deleting model 'UserMarkLog'
        db.delete_table(u'transaction_usermarklog')

        # Deleting model 'DownloadResumeMark'
        db.delete_table(u'transaction_downloadresumemark')

        # Deleting model 'AdminMarkLog'
        db.delete_table(u'transaction_adminmarklog')
    ...
    models = {
        ...
        u'jobs.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 24, 0, 0)'}),
        ...
        u'jobs.sendcompanycard': {
            ...
            'feedback_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 24, 0, 0)'}),
            ...
            'send_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 24, 0, 0)'}),
        ...
        u'transaction.downloadresumemark': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_mark': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'mark_status': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
        ...
        u'transaction.userchargepackage': {
            ...
            'feed_end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 4, 23, 0, 0)', 'db_index': 'True'}),
            ...
            'resume_end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 4, 23, 0, 0)', 'db_index': 'True'}),
            'resume_package': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['pinbot_package.ResumePackge']", 'null': 'True', 'blank': 'True'}),
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 24, 0, 0)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
        ...
        u'transaction.userresumefeedback': {
            ...
            'create_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 24, 0, 0)', 'null': 'True', 'blank': 'True'}),
