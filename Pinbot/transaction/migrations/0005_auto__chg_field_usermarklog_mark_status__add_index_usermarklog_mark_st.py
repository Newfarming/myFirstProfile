...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'UserMarkLog.mark_status' to match new field type.
        db.rename_column(u'transaction_usermarklog', 'mark_status', 'mark_status_id')
        # Changing field 'UserMarkLog.mark_status'
        db.alter_column(u'transaction_usermarklog', 'mark_status_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['system.ResumeMarkSetting']))
        # Adding index on 'UserMarkLog', fields ['mark_status']
        db.create_index(u'transaction_usermarklog', ['mark_status_id'])


        # Renaming column for 'DownloadResumeMark.last_mark' to match new field type.
        db.rename_column(u'transaction_downloadresumemark', 'last_mark', 'last_mark_id')
        # Changing field 'DownloadResumeMark.last_mark'
        db.alter_column(u'transaction_downloadresumemark', 'last_mark_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['system.ResumeMarkSetting']))
        # Adding index on 'DownloadResumeMark', fields ['last_mark']
        db.create_index(u'transaction_downloadresumemark', ['last_mark_id'])


        # Renaming column for 'DownloadResumeMark.mark_status' to match new field type.
        db.rename_column(u'transaction_downloadresumemark', 'mark_status', 'mark_status_id')
        # Changing field 'DownloadResumeMark.mark_status'
        db.alter_column(u'transaction_downloadresumemark', 'mark_status_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['system.ResumeMarkSetting']))
        # Adding index on 'DownloadResumeMark', fields ['mark_status']
        db.create_index(u'transaction_downloadresumemark', ['mark_status_id'])


    def backwards(self, orm):
        # Removing index on 'DownloadResumeMark', fields ['mark_status']
        db.delete_index(u'transaction_downloadresumemark', ['mark_status_id'])

        # Removing index on 'DownloadResumeMark', fields ['last_mark']
        db.delete_index(u'transaction_downloadresumemark', ['last_mark_id'])

        # Removing index on 'UserMarkLog', fields ['mark_status']
        db.delete_index(u'transaction_usermarklog', ['mark_status_id'])


        # Renaming column for 'UserMarkLog.mark_status' to match new field type.
        db.rename_column(u'transaction_usermarklog', 'mark_status_id', 'mark_status')
        # Changing field 'UserMarkLog.mark_status'
        db.alter_column(u'transaction_usermarklog', 'mark_status', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Renaming column for 'DownloadResumeMark.last_mark' to match new field type.
        db.rename_column(u'transaction_downloadresumemark', 'last_mark_id', 'last_mark')
        # Changing field 'DownloadResumeMark.last_mark'
        db.alter_column(u'transaction_downloadresumemark', 'last_mark', self.gf('django.db.models.fields.CharField')(default=None, max_length=20))

        # Renaming column for 'DownloadResumeMark.mark_status' to match new field type.
        db.rename_column(u'transaction_downloadresumemark', 'mark_status_id', 'mark_status')
        # Changing field 'DownloadResumeMark.mark_status'
        db.alter_column(u'transaction_downloadresumemark', 'mark_status', self.gf('django.db.models.fields.CharField')(max_length=20))
    ...
    models = {
        ...
        u'jobs.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 27, 0, 0)'}),
        ...
        u'jobs.sendcompanycard': {
            ...
            'feedback_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 27, 0, 0)'}),
            ...
            'send_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 27, 0, 0)'}),
        ...
        u'transaction.downloadresumemark': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_mark': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'last_marks'", 'null': 'True', 'to': u"orm['system.ResumeMarkSetting']"}),
            'mark_status': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'current_marks'", 'to': u"orm['system.ResumeMarkSetting']"}),
        ...
        u'transaction.userchargepackage': {
            ...
            'feed_end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 4, 26, 0, 0)', 'db_index': 'True'}),
            ...
            'resume_end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 4, 26, 0, 0)', 'db_index': 'True'}),
            'resume_package': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['pinbot_package.ResumePackge']", 'null': 'True', 'blank': 'True'}),
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 27, 0, 0)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
        ...
        u'transaction.usermarklog': {
            ...
            'desc': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mark_status': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'mark_logs'", 'to': u"orm['system.ResumeMarkSetting']"}),
        ...
        u'transaction.userresumefeedback': {
            ...
            'create_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 27, 0, 0)', 'null': 'True', 'blank': 'True'}),
