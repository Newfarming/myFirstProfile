...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InterviewAlarm'
        db.create_table(u'transaction_interviewalarm', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('buy_record', self.gf('django.db.models.fields.related.OneToOneField')(related_name='interview_alarm', unique=True, to=orm['transaction.ResumeBuyRecord'])),
            ('interview_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('interview_time', self.gf('django.db.models.fields.DateTimeField')(db_index=True)),
            ('create_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('has_alarm', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'transaction', ['InterviewAlarm'])


    def backwards(self, orm):
        # Deleting model 'InterviewAlarm'
        db.delete_table(u'transaction_interviewalarm')
    ...
    models = {
        ...
        u'jobs.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 15, 0, 0)'}),
        ...
        u'jobs.sendcompanycard': {
            ...
            'feedback_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 15, 0, 0)'}),
            ...
            'send_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 15, 0, 0)'}),
        ...
        u'transaction.userchargepackage': {
            ...
            'feed_end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2017, 1, 14, 0, 0)', 'db_index': 'True'}),
            ...
            'resume_end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2017, 1, 14, 0, 0)', 'db_index': 'True'}),
            'resume_package': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['pinbot_package.ResumePackge']", 'null': 'True', 'blank': 'True'}),
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 15, 0, 0)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
        ...
        u'transaction.userresumefeedback': {
            ...
            'create_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 15, 0, 0)', 'null': 'True', 'blank': 'True'}),
