...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'UserChargePackage', fields ['feed_end_time']
        db.create_index(u'transaction_userchargepackage', ['feed_end_time'])

        # Adding index on 'UserChargePackage', fields ['resume_end_time']
        db.create_index(u'transaction_userchargepackage', ['resume_end_time'])


        # Changing field 'ResumeBuyRecord.resume_url'
        db.alter_column(u'transaction_resumebuyrecord', 'resume_url', self.gf('django.db.models.fields.URLField')(max_length=1000))

    def backwards(self, orm):
        # Removing index on 'UserChargePackage', fields ['resume_end_time']
        db.delete_index(u'transaction_userchargepackage', ['resume_end_time'])

        # Removing index on 'UserChargePackage', fields ['feed_end_time']
        db.delete_index(u'transaction_userchargepackage', ['feed_end_time'])


        # Changing field 'ResumeBuyRecord.resume_url'
        db.alter_column(u'transaction_resumebuyrecord', 'resume_url', self.gf('django.db.models.fields.URLField')(max_length=200))
    ...
    models = {
        ...
        u'jobs.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 26, 0, 0)'}),
        ...
        u'jobs.sendcompanycard': {
            ...
            'feedback_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 26, 0, 0)'}),
            ...
            'send_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 26, 0, 0)'}),
        ...
        u'transaction.userchargepackage': {
            ...
            'feed_end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 3, 25, 0, 0)', 'db_index': 'True'}),
            ...
            'resume_end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 3, 25, 0, 0)', 'db_index': 'True'}),
            'resume_package': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['pinbot_package.ResumePackge']", 'null': 'True', 'blank': 'True'}),
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 26, 0, 0)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
        ...
        u'transaction.userresumefeedback': {
            ...
            'create_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 26, 0, 0)', 'null': 'True', 'blank': 'True'}),
