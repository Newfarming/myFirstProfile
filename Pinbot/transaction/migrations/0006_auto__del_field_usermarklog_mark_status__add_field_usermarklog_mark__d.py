...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserMarkLog.mark_status'
        db.delete_column(u'transaction_usermarklog', 'mark_status_id')

        # Adding field 'UserMarkLog.mark'
        db.add_column(u'transaction_usermarklog', 'mark',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='mark_logs', to=orm['system.ResumeMarkSetting']),
                      keep_default=False)

        # Deleting field 'DownloadResumeMark.mark_status'
        db.delete_column(u'transaction_downloadresumemark', 'mark_status_id')

        # Adding field 'DownloadResumeMark.current_mark'
        db.add_column(u'transaction_downloadresumemark', 'current_mark',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='current_marks', to=orm['system.ResumeMarkSetting']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserMarkLog.mark_status'
        db.add_column(u'transaction_usermarklog', 'mark_status',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='mark_logs', to=orm['system.ResumeMarkSetting']),
                      keep_default=False)

        # Deleting field 'UserMarkLog.mark'
        db.delete_column(u'transaction_usermarklog', 'mark_id')

        # Adding field 'DownloadResumeMark.mark_status'
        db.add_column(u'transaction_downloadresumemark', 'mark_status',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='current_marks', to=orm['system.ResumeMarkSetting']),
                      keep_default=False)

        # Deleting field 'DownloadResumeMark.current_mark'
        db.delete_column(u'transaction_downloadresumemark', 'current_mark_id')
    ...
    models = {
        ...
        u'transaction.downloadresumemark': {
            ...
            'current_mark': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'current_marks'", 'to': u"orm['system.ResumeMarkSetting']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'transaction.usermarklog': {
            ...
            'desc': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mark': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'mark_logs'", 'to': u"orm['system.ResumeMarkSetting']"}),
