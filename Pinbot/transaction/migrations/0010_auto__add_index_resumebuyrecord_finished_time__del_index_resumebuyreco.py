...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'ResumeBuyRecord', fields ['finished_time']
        db.create_index(u'transaction_resumebuyrecord', ['finished_time'])

        # Removing index on 'ResumeBuyRecord', fields ['op_time']
        db.delete_index(u'transaction_resumebuyrecord', ['op_time'])


    def backwards(self, orm):
        # Adding index on 'ResumeBuyRecord', fields ['op_time']
        db.create_index(u'transaction_resumebuyrecord', ['op_time'])

        # Removing index on 'ResumeBuyRecord', fields ['finished_time']
        db.delete_index(u'transaction_resumebuyrecord', ['finished_time'])
    ...
    models = {
        ...
        u'jobs.sendcompanycard': {
            ...
            'feedback_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 6, 0, 0)'}),
            ...
            'send_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 6, 0, 0)'}),
        ...
        u'transaction.userchargepackage': {
            ...
            'feed_end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 5, 5, 0, 0)', 'db_index': 'True'}),
            ...
            'resume_end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 5, 5, 0, 0)', 'db_index': 'True'}),
            'resume_package': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['pinbot_package.ResumePackge']", 'null': 'True', 'blank': 'True'}),
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 6, 0, 0)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
        ...
        u'transaction.userresumefeedback': {
            ...
            'create_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 6, 0, 0)', 'null': 'True', 'blank': 'True'}),
