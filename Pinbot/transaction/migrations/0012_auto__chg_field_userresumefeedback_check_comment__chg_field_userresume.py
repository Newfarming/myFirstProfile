...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserResumeFeedback.check_comment'
        db.alter_column('transaction_userresumefeedback', 'check_comment', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'UserResumeFeedback.feedback_value'
        db.alter_column('transaction_userresumefeedback', 'feedback_value', self.gf('django.db.models.fields.CharField')(max_length=50))
        # Adding index on 'ResumeBuyRecord', fields ['resume_id']
        db.create_index(u'transaction_resumebuyrecord', ['resume_id'])

        # Adding unique constraint on 'ResumeBuyRecord', fields ['user', 'resume_id']
        db.create_unique(u'transaction_resumebuyrecord', ['user_id', 'resume_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ResumeBuyRecord', fields ['user', 'resume_id']
        db.delete_unique(u'transaction_resumebuyrecord', ['user_id', 'resume_id'])

        # Removing index on 'ResumeBuyRecord', fields ['resume_id']
        db.delete_index(u'transaction_resumebuyrecord', ['resume_id'])


        # Changing field 'UserResumeFeedback.check_comment'
        db.alter_column('transaction_userresumefeedback', 'check_comment', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'UserResumeFeedback.feedback_value'
        db.alter_column('transaction_userresumefeedback', 'feedback_value', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
    ...
    models = {
        ...
        u'jobs.sendcompanycard': {
            ...
            'feedback_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 1, 0, 0)'}),
            ...
            'send_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 1, 0, 0)'}),
        ...
        u'transaction.userchargepackage': {
            ...
            'feed_end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 6, 30, 0, 0)', 'db_index': 'True'}),
            ...
            'resume_end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 6, 30, 0, 0)', 'db_index': 'True'}),
            'resume_package': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['pinbot_package.ResumePackge']", 'null': 'True', 'blank': 'True'}),
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 1, 0, 0)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
        ...
        u'transaction.userresumefeedback': {
            ...
            'create_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 1, 0, 0)', 'null': 'True', 'blank': 'True'}),
