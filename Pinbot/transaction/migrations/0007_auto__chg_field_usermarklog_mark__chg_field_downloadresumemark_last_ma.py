...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserMarkLog.mark'
        db.alter_column(u'transaction_usermarklog', 'mark_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['system.ResumeMarkSetting']))

        # Changing field 'DownloadResumeMark.last_mark'
        db.alter_column(u'transaction_downloadresumemark', 'last_mark_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['system.ResumeMarkSetting']))

        # Changing field 'DownloadResumeMark.current_mark'
        db.alter_column(u'transaction_downloadresumemark', 'current_mark_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['system.ResumeMarkSetting']))

    def backwards(self, orm):

        # Changing field 'UserMarkLog.mark'
        db.alter_column(u'transaction_usermarklog', 'mark_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['system.ResumeMarkSetting']))
        ...
        # Changing field 'DownloadResumeMark.current_mark'
        db.alter_column(u'transaction_downloadresumemark', 'current_mark_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['system.ResumeMarkSetting']))
    ...
    models = {
        ...
        u'jobs.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 4, 0, 0)'}),
        ...
        u'jobs.sendcompanycard': {
            ...
            'feedback_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 4, 0, 0)'}),
            ...
            'send_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 4, 0, 0)'}),
        ...
        u'transaction.userchargepackage': {
            ...
            'feed_end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 5, 3, 0, 0)', 'db_index': 'True'}),
            ...
            'resume_end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 5, 3, 0, 0)', 'db_index': 'True'}),
            'resume_package': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['pinbot_package.ResumePackge']", 'null': 'True', 'blank': 'True'}),
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 4, 0, 0)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
        ...
        u'transaction.userresumefeedback': {
            ...
            'create_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 4, 0, 0)', 'null': 'True', 'blank': 'True'}),
