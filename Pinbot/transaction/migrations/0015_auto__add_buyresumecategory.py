...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BuyResumeCategory'
        db.create_table(u'transaction_buyresumecategory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='buy_resume_categories', to=orm['auth.User'])),
            ('category_name', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('create_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'transaction', ['BuyResumeCategory'])

        # Adding M2M table for field resumes on 'BuyResumeCategory'
        m2m_table_name = db.shorten_name(u'transaction_buyresumecategory_resumes')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('buyresumecategory', models.ForeignKey(orm[u'transaction.buyresumecategory'], null=False)),
            ('resumebuyrecord', models.ForeignKey(orm[u'transaction.resumebuyrecord'], null=False))
        ))
        db.create_unique(m2m_table_name, ['buyresumecategory_id', 'resumebuyrecord_id'])


    def backwards(self, orm):
        # Deleting model 'BuyResumeCategory'
        db.delete_table(u'transaction_buyresumecategory')

        # Removing M2M table for field resumes on 'BuyResumeCategory'
        db.delete_table(db.shorten_name(u'transaction_buyresumecategory_resumes'))
    ...
    models = {
        ...
        u'jobs.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 18, 0, 0)'}),
        ...
        u'jobs.sendcompanycard': {
            ...
            'feedback_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 18, 0, 0)'}),
            ...
            'send_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 18, 0, 0)'}),
        ...
        u'transaction.buyresumecategory': {
            'Meta': {'object_name': 'BuyResumeCategory'},
            'category_name': ('django.db.models.fields.CharField', [], {'max_length': '15'}),
            'create_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'resumes': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'resume_categories'", 'symmetrical': 'False', 'to': u"orm['transaction.ResumeBuyRecord']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'buy_resume_categories'", 'to': u"orm['auth.User']"})
        },
        ...
        u'transaction.interviewalarm': {
            'Meta': {'object_name': 'InterviewAlarm'},
            'buy_record': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'interview_alarm'", 'unique': 'True', 'to': u"orm['transaction.ResumeBuyRecord']"}),
            'create_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'has_alarm': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'interview_count': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'interview_time': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True'})
        },
        ...
        u'transaction.userchargepackage': {
            ...
            'feed_end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2017, 1, 17, 0, 0)', 'db_index': 'True'}),
            ...
            'resume_end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2017, 1, 17, 0, 0)', 'db_index': 'True'}),
            'resume_package': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['pinbot_package.ResumePackge']", 'null': 'True', 'blank': 'True'}),
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 18, 0, 0)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
        ...
        u'transaction.usermarklog': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'user_mark_logs'", 'null': 'True', 'to': u"orm['auth.User']"})
        },
        u'transaction.userresumefeedback': {
            'Meta': {'object_name': 'UserResumeFeedback'},
            'check_comment': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50', 'blank': 'True'}),
            'check_status': ('django.db.models.fields.CharField', [], {'default': "'checking'", 'max_length': '50'}),
            'create_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 18, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'feedback_info': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['transaction.FeedBackInfo']"}),
            'feedback_value': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
