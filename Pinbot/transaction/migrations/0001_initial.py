...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('transaction_feedbacktype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('desc', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('re_points', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'transaction', ['FeedBackType'])

        # Adding model 'FeedBackInfo'
        db.create_table('transaction_feedbackinfo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['transaction.FeedBackType'])),
            ('feedback_id', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('feedback_desc', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'transaction', ['FeedBackInfo'])

        # Adding model 'UserResumeFeedback'
        db.create_table('transaction_userresumefeedback', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('resume_id', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('feedback_info', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['transaction.FeedBackInfo'])),
            ('feedback_value', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('check_status', self.gf('django.db.models.fields.CharField')(default='checking', max_length=50)),
            ('check_comment', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('notify_status', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('create_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 2, 1, 0, 0), null=True, blank=True)),
        ))
        db.send_create_signal(u'transaction', ['UserResumeFeedback'])

        # Adding model 'UserChargePackage'
        db.create_table(u'transaction_userchargepackage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('package_type', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('resume_package', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pinbot_package.ResumePackge'], null=True, blank=True)),
            ('feed_package', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pinbot_package.FeedService'], null=True, blank=True)),
            ('extra_feed_num', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('start_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 2, 1, 0, 0))),
            ('resume_end_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2016, 2, 1, 0, 0))),
            ('feed_end_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2016, 2, 1, 0, 0))),
            ('actual_cost', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('rest_feed', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('rest_points', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('re_points', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('pay_status', self.gf('django.db.models.fields.CharField')(default='Start', max_length=50)),
            ('zero_points_notify_status', self.gf('django.db.models.fields.CharField')(default='read', max_length=50)),
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['payment.PaymentOrder'], null=True, blank=True)),
        ))
        db.send_create_signal(u'transaction', ['UserChargePackage'])

        # Adding model 'ResumeBuyRecord'
        db.create_table(u'transaction_resumebuyrecord', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('resume_id', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('resume_url', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('op_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('finished_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 1, 1, 0, 0), null=True, blank=True)),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('feed_id', self.gf('django.db.models.fields.CharField')(default='', max_length=100, null=True, blank=True)),
            ('keywords', self.gf('django.db.models.fields.CharField')(default='', max_length=100)),
            ('feedback_info', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['transaction.FeedBackInfo'], null=True, blank=True)),
            ('send_card', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['jobs.SendCompanyCard'], null=True, blank=True)),
        ))
        db.send_create_signal(u'transaction', ['ResumeBuyRecord'])


    def backwards(self, orm):
        # Deleting model 'FeedBackType'
        db.delete_table('transaction_feedbacktype')

        # Deleting model 'FeedBackInfo'
        db.delete_table('transaction_feedbackinfo')

        # Deleting model 'UserResumeFeedback'
        db.delete_table('transaction_userresumefeedback')

        # Deleting model 'UserChargePackage'
        db.delete_table(u'transaction_userchargepackage')

        # Deleting model 'ResumeBuyRecord'
        db.delete_table(u'transaction_resumebuyrecord')
