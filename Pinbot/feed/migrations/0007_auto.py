...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field job_domain on 'Feed'
        m2m_table_name = db.shorten_name('feed_feed_job_domain')
        ...
        db.create_unique(m2m_table_name, ['feed_id', 'companycategory_id'])


    def backwards(self, orm):
        # Removing M2M table for field job_domain on 'Feed'
        db.delete_table(db.shorten_name('feed_feed_job_domain'))
    ...
    models = {
        ...
        'feed.feed': {
            ...
            'delete_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 10, 0, 0)'}),
            ...
            'feed_expire_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 18, 0, 0)'}),
            ...
            'last_click_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 10, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'transaction.userchargepackage': {
            ...
            'feed_end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 3, 9, 0, 0)'}),
            ...
            'resume_end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 3, 9, 0, 0)'}),
            'resume_package': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['pinbot_package.ResumePackge']", 'null': 'True', 'blank': 'True'}),
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 10, 0, 0)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
