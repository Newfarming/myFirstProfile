...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Feed.analyze_titles'
        db.add_column('feed_feed', 'analyze_titles',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=350, blank=True),
                      keep_default=False)


        # Changing field 'Feed.keywords'
        db.alter_column('feed_feed', 'keywords', self.gf('django.db.models.fields.CharField')(max_length=350))

    def backwards(self, orm):
        # Deleting field 'Feed.analyze_titles'
        db.delete_column('feed_feed', 'analyze_titles')


        # Changing field 'Feed.keywords'
        db.alter_column('feed_feed', 'keywords', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        'feed.feed': {
            ...
            'feed_expire_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 22, 0, 0)', 'db_index': 'True'}),
        ...
        u'feed.userfeed': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'delete_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 14, 0, 0)'}),
            'expire_time': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'feed': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['feed.Feed']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'jobs.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 14, 0, 0)'}),
        ...
        u'transaction.userchargepackage': {
            ...
            'feed_end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 12, 13, 0, 0)', 'db_index': 'True'}),
            ...
            'resume_end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 12, 13, 0, 0)', 'db_index': 'True'}),
            'resume_package': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['pinbot_package.ResumePackge']", 'null': 'True', 'blank': 'True'}),
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 14, 0, 0)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
