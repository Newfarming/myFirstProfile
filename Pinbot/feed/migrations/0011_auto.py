...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'feed_feed_job_prefer'))

        # Adding M2M table for field company_prefer on 'Feed'
        m2m_table_name = db.shorten_name('feed_feed_company_prefer')
    ...
    def backwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'feed_feed_job_prefer')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('feed', models.ForeignKey(orm['feed.feed'], null=False)),
            ('companycategoryprefer', models.ForeignKey(orm[u'system.companycategoryprefer'], null=False))
        ...
        # Removing M2M table for field company_prefer on 'Feed'
        db.delete_table(db.shorten_name('feed_feed_company_prefer'))
