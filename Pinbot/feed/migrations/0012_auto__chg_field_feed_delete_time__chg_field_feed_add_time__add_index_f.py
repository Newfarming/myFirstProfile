...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Feed.delete_time'
        db.alter_column('feed_feed', 'delete_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Feed.add_time'
        db.alter_column('feed_feed', 'add_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
        # Adding index on 'Feed', fields ['feed_expire_time']
        db.create_index('feed_feed', ['feed_expire_time'])


    def backwards(self, orm):
        # Removing index on 'Feed', fields ['feed_expire_time']
        db.delete_index('feed_feed', ['feed_expire_time'])


        # Changing field 'Feed.delete_time'
        db.alter_column('feed_feed', 'delete_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Feed.add_time'
        db.alter_column('feed_feed', 'add_time', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        'feed.feed': {
            ...
            'feed_expire_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 26, 0, 0)', 'db_index': 'True'}),
        ...
        u'feed.userfeed': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'delete_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 18, 0, 0)'}),
            'expire_time': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'feed': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['feed.Feed']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'jobs.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 18, 0, 0)'}),
        ...
        u'transaction.userchargepackage': {
            ...
            'feed_end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 6, 17, 0, 0)', 'db_index': 'True'}),
            ...
            'resume_end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 6, 17, 0, 0)', 'db_index': 'True'}),
            'resume_package': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['pinbot_package.ResumePackge']", 'null': 'True', 'blank': 'True'}),
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 18, 0, 0)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
