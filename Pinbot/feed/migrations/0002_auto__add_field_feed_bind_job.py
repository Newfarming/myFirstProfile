...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('feed_feed', 'bind_job',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('feed_feed', 'bind_job_id')
    ...
    models = {
        ...
        u'my_resume.resume': {
            ...
            'resume_id': ('django.db.models.fields.CharField', [], {'default': "'54aa80178230db4fa202dd64'", 'max_length': '50'}),
