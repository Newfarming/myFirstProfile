...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'weixin.autoreplyresumelog': {
            'Meta': {'object_name': 'AutoReplyResumeLog'},
            'add_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'reply_content': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'weixin_user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'auto_reply_weixin_user'", 'to': u"orm['weixin.WeixinUser']"})
        },
        u'weixin.msgsendlog': {
