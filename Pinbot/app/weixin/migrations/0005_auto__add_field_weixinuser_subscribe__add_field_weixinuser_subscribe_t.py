...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WeixinUser.subscribe'
        db.add_column(u'weixin_weixinuser', 'subscribe',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'WeixinUser.subscribe_time'
        db.add_column(u'weixin_weixinuser', 'subscribe_time',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'WeixinUser.remark'
        db.add_column(u'weixin_weixinuser', 'remark',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'WeixinUser.language'
        db.add_column(u'weixin_weixinuser', 'language',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'WeixinUser.groupid'
        db.add_column(u'weixin_weixinuser', 'groupid',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WeixinUser.subscribe'
        db.delete_column(u'weixin_weixinuser', 'subscribe')

        # Deleting field 'WeixinUser.subscribe_time'
        db.delete_column(u'weixin_weixinuser', 'subscribe_time')

        # Deleting field 'WeixinUser.remark'
        db.delete_column(u'weixin_weixinuser', 'remark')

        # Deleting field 'WeixinUser.language'
        db.delete_column(u'weixin_weixinuser', 'language')

        # Deleting field 'WeixinUser.groupid'
        db.delete_column(u'weixin_weixinuser', 'groupid')
