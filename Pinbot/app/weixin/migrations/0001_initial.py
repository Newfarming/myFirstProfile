...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'weixin_weixinuser', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='weixin_user', to=orm['auth.User'])),
            ('openid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
            ...
            ('headimgurl', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('privilege', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('unionid', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
    ...
    models = {
        ...
        u'weixin.weixinuser': {
            ...
            'headimgurl': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'weixin_user'", 'to': u"orm['auth.User']"})
        }
    }
