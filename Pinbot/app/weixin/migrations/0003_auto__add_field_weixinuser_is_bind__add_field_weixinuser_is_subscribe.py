...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WeixinUser.is_bind'
        db.add_column(u'weixin_weixinuser', 'is_bind',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'WeixinUser.is_subscribe'
        db.add_column(u'weixin_weixinuser', 'is_subscribe',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WeixinUser.is_bind'
        db.delete_column(u'weixin_weixinuser', 'is_bind')

        # Deleting field 'WeixinUser.is_subscribe'
        db.delete_column(u'weixin_weixinuser', 'is_subscribe')
    ...
    models = {
        ...
        u'weixin.weixinuser': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_bind': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_subscribe': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
