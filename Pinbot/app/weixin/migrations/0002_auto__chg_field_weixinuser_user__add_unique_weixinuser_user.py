...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'weixin_weixinuser', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['auth.User']))
        # Adding unique constraint on 'WeixinUser', fields ['user']
        db.create_unique(u'weixin_weixinuser', ['user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'WeixinUser', fields ['user']
        db.delete_unique(u'weixin_weixinuser', ['user_id'])


        # Changing field 'WeixinUser.user'
        db.alter_column(u'weixin_weixinuser', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
