...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserVip.active_time'
        db.add_column(u'vip_uservip', 'active_time',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2015, 3, 26, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserVip.active_time'
        db.delete_column(u'vip_uservip', 'active_time')
