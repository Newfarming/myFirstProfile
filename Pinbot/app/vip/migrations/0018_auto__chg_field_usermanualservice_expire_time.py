...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserManualService.expire_time'
        db.alter_column(u'vip_usermanualservice', 'expire_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2015, 9, 1, 0, 0)))

    def backwards(self, orm):

        # Changing field 'UserManualService.expire_time'
        db.alter_column(u'vip_usermanualservice', 'expire_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))
