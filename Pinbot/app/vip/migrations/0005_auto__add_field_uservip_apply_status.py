...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserVip.apply_status'
        db.add_column(u'vip_uservip', 'apply_status',
                      self.gf('django.db.models.fields.CharField')(default='applying', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserVip.apply_status'
        db.delete_column(u'vip_uservip', 'apply_status')
