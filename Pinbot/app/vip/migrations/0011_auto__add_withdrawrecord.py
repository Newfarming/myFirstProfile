...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WithdrawRecord'
        db.create_table(u'vip_withdrawrecord', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='withdraw_records', to=orm['auth.User'])),
            ...
            ('verify_remark', self.gf('django.db.models.fields.CharField')(default=0, max_length=100)),
            ('verify_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('money', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal(u'vip', ['WithdrawRecord'])


    def backwards(self, orm):
        # Deleting model 'WithdrawRecord'
        db.delete_table(u'vip_withdrawrecord')
    ...
    models = {
        ...
        u'vip.withdrawrecord': {
            ...
            'verify_remark': ('django.db.models.fields.CharField', [], {'default': '0', 'max_length': '100'}),
