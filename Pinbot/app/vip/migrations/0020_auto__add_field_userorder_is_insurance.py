...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserOrder.is_insurance'
        db.add_column(u'vip_userorder', 'is_insurance',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserOrder.is_insurance'
        db.delete_column(u'vip_userorder', 'is_insurance')
