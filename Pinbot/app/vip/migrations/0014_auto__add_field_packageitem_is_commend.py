...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PackageItem.is_commend'
        db.add_column(u'vip_packageitem', 'is_commend',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PackageItem.is_commend'
        db.delete_column(u'vip_packageitem', 'is_commend')
