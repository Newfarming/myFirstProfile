...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VipRoleSetting.price'
        db.alter_column(u'vip_viprolesetting', 'price', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'VipRoleSetting.price'
        db.alter_column(u'vip_viprolesetting', 'price', self.gf('django.db.models.fields.IntegerField')())
