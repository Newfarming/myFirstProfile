...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserManualService.order_price'
        db.add_column(u'vip_usermanualservice', 'order_price',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserManualService.order_price'
        db.delete_column(u'vip_usermanualservice', 'order_price')
