...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VipRoleSetting.service_time'
        db.add_column(u'vip_viprolesetting', 'service_time',
                      self.gf('django.db.models.fields.IntegerField')(default=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VipRoleSetting.service_time'
        db.delete_column(u'vip_viprolesetting', 'service_time')
    ...
    models = {
        ...
        u'vip.usermanualservice': {
            ...
            'create_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'expire_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
        ...
        u'vip.uservip': {
            ...
            'expire_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 7, 0, 0)'}),
            'has_sign': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'total_price': ('django.db.models.fields.FloatField', [], {'default': '0'}),
        ...
        u'vip.viprolesetting': {
            ...
            'price': ('django.db.models.fields.FloatField', [], {}),
            'product_name': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            'service_time': ('django.db.models.fields.IntegerField', [], {'default': '3'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'enable'", 'max_length': '20'}),
