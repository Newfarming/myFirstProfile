...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VipRoleSetting.agreement'
        db.add_column(u'vip_viprolesetting', 'agreement',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'VipRoleSetting.level'
        db.add_column(u'vip_viprolesetting', 'level',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'UserVip.has_sign'
        db.add_column(u'vip_uservip', 'has_sign',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VipRoleSetting.agreement'
        db.delete_column(u'vip_viprolesetting', 'agreement')

        # Deleting field 'VipRoleSetting.level'
        db.delete_column(u'vip_viprolesetting', 'level')

        # Deleting field 'UserVip.has_sign'
        db.delete_column(u'vip_uservip', 'has_sign')
