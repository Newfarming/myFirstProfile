...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Mission.grant_status'
        db.add_column(u'vip_mission', 'grant_status',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Mission.grant_status'
        db.delete_column(u'vip_mission', 'grant_status')
