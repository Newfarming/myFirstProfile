...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'UserManualService', fields ['expire_time']
        db.create_index(u'vip_usermanualservice', ['expire_time'])


    def backwards(self, orm):
        # Removing index on 'UserManualService', fields ['expire_time']
        db.delete_index(u'vip_usermanualservice', ['expire_time'])
    ...
    models = {
        ...
        u'vip.uservip': {
            ...
            'expire_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 11, 16, 0, 0)'}),
            'has_sign': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'total_price': ('django.db.models.fields.FloatField', [], {'default': '0'}),
