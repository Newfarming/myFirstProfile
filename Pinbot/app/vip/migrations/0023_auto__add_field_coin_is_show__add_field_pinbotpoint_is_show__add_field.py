...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Coin.is_show'
        db.add_column(u'vip_coin', 'is_show',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PinbotPoint.is_show'
        db.add_column(u'vip_pinbotpoint', 'is_show',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PackageItem.is_show'
        db.add_column(u'vip_packageitem', 'is_show',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Coin.is_show'
        db.delete_column(u'vip_coin', 'is_show')

        # Deleting field 'PinbotPoint.is_show'
        db.delete_column(u'vip_pinbotpoint', 'is_show')

        # Deleting field 'PackageItem.is_show'
        db.delete_column(u'vip_packageitem', 'is_show')
