...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserOrder.order_remark'
        db.add_column(u'vip_userorder', 'order_remark',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserOrder.order_remark'
        db.delete_column(u'vip_userorder', 'order_remark')
