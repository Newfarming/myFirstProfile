...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'PackageItem', fields ['product_name']
        db.delete_unique(u'vip_packageitem', ['product_name'])

        # Removing unique constraint on 'PackageItem', fields ['code_name']
        db.delete_unique(u'vip_packageitem', ['code_name'])

        # Removing unique constraint on 'PinbotPoint', fields ['product_name']
        db.delete_unique(u'vip_pinbotpoint', ['product_name'])

        # Removing unique constraint on 'PinbotPoint', fields ['code_name']
        db.delete_unique(u'vip_pinbotpoint', ['code_name'])

        # Removing unique constraint on 'Coin', fields ['product_name']
        db.delete_unique(u'vip_coin', ['product_name'])

        # Removing unique constraint on 'Coin', fields ['code_name']
        db.delete_unique(u'vip_coin', ['code_name'])

        # Adding field 'VipRoleSetting.product_name'
        db.add_column(u'vip_viprolesetting', 'product_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=40),
                      keep_default=False)

        # Adding field 'VipRoleSetting.desc'
        db.add_column(u'vip_viprolesetting', 'desc',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'VipRoleSetting.create_time'
        db.add_column(u'vip_viprolesetting', 'create_time',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default='2015-08-28', blank=True),
                      keep_default=False)

        # Adding field 'VipRoleSetting.status'
        db.add_column(u'vip_viprolesetting', 'status',
                      self.gf('django.db.models.fields.CharField')(default='enable', max_length=20),
                      keep_default=False)


        # Changing field 'VipRoleSetting.code_name'
        db.alter_column(u'vip_viprolesetting', 'code_name', self.gf('django.db.models.fields.CharField')(max_length=40))

    def backwards(self, orm):
        # Deleting field 'VipRoleSetting.product_name'
        db.delete_column(u'vip_viprolesetting', 'product_name')

        # Deleting field 'VipRoleSetting.desc'
        db.delete_column(u'vip_viprolesetting', 'desc')

        # Deleting field 'VipRoleSetting.create_time'
        db.delete_column(u'vip_viprolesetting', 'create_time')

        # Deleting field 'VipRoleSetting.status'
        db.delete_column(u'vip_viprolesetting', 'status')


        # Changing field 'VipRoleSetting.code_name'
        db.alter_column(u'vip_viprolesetting', 'code_name', self.gf('django.db.models.fields.CharField')(max_length=20))
        # Adding unique constraint on 'Coin', fields ['code_name']
        db.create_unique(u'vip_coin', ['code_name'])

        # Adding unique constraint on 'Coin', fields ['product_name']
        db.create_unique(u'vip_coin', ['product_name'])

        # Adding unique constraint on 'PinbotPoint', fields ['code_name']
        db.create_unique(u'vip_pinbotpoint', ['code_name'])

        # Adding unique constraint on 'PinbotPoint', fields ['product_name']
        db.create_unique(u'vip_pinbotpoint', ['product_name'])

        # Adding unique constraint on 'PackageItem', fields ['code_name']
        db.create_unique(u'vip_packageitem', ['code_name'])

        # Adding unique constraint on 'PackageItem', fields ['product_name']
        db.create_unique(u'vip_packageitem', ['product_name'])
