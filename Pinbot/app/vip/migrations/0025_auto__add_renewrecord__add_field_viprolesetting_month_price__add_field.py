...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RenewRecord'
        db.create_table(u'vip_renewrecord', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user_vip', self.gf('django.db.models.fields.related.ForeignKey')(related_name='renew_records', to=orm['vip.UserVip'])),
            ('duration', self.gf('django.db.models.fields.IntegerField')()),
            ('price', self.gf('django.db.models.fields.FloatField')()),
            ('create_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'vip', ['RenewRecord'])

        # Adding field 'VipRoleSetting.month_price'
        db.add_column(u'vip_viprolesetting', 'month_price',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'UserVip.expire_time'
        db.add_column(u'vip_uservip', 'expire_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 11, 5, 0, 0)),
                      keep_default=False)

        # Adding field 'UserVip.total_price'
        db.add_column(u'vip_uservip', 'total_price',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'RenewRecord'
        db.delete_table(u'vip_renewrecord')

        # Deleting field 'VipRoleSetting.month_price'
        db.delete_column(u'vip_viprolesetting', 'month_price')

        # Deleting field 'UserVip.expire_time'
        db.delete_column(u'vip_uservip', 'expire_time')

        # Deleting field 'UserVip.total_price'
        db.delete_column(u'vip_uservip', 'total_price')
    ...
    models = {
        ...
        u'vip.renewrecord': {
            'Meta': {'object_name': 'RenewRecord'},
            'create_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'duration': ('django.db.models.fields.IntegerField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'price': ('django.db.models.fields.FloatField', [], {}),
            'user_vip': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'renew_records'", 'to': u"orm['vip.UserVip']"})
        },
        u'vip.usermanualservice': {
            ...
            'create_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'expire_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'order_price': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
        ...
        u'vip.uservip': {
            ...
            'expire_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 11, 5, 0, 0)'}),
            'has_sign': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'total_price': ('django.db.models.fields.FloatField', [], {'default': '0'}),
        ...
        u'vip.viprolesetting': {
            ...
            'month_price': ('django.db.models.fields.FloatField', [], {'default': '0'}),
