...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserOrder.user'
        db.add_column(u'vip_userorder', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='user_orders', to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserOrder.user'
        db.delete_column(u'vip_userorder', 'user_id')
