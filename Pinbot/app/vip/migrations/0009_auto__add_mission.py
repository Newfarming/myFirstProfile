...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'vip_mission', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='missions', to=orm['auth.User'])),
            ('mission_type', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('mission_status', self.gf('django.db.models.fields.CharField')(default='start', max_length=30)),
            ('start_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('finish_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'vip', ['Mission'])


    def backwards(self, orm):
        # Deleting model 'Mission'
        db.delete_table(u'vip_mission')
