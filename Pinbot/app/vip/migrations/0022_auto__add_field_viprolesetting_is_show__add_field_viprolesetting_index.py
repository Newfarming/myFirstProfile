...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VipRoleSetting.is_show'
        db.add_column(u'vip_viprolesetting', 'is_show',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'VipRoleSetting.index'
        db.add_column(u'vip_viprolesetting', 'index',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VipRoleSetting.is_show'
        db.delete_column(u'vip_viprolesetting', 'is_show')

        # Deleting field 'VipRoleSetting.index'
        db.delete_column(u'vip_viprolesetting', 'index')
