...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VipRoleSetting.allow_apply'
        db.add_column(u'vip_viprolesetting', 'allow_apply',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VipRoleSetting.allow_apply'
        db.delete_column(u'vip_viprolesetting', 'allow_apply')
