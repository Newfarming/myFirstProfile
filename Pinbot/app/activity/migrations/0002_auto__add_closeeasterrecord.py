...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CloseEasterRecord'
        db.create_table(u'activity_closeeasterrecord', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('username', self.gf('django.db.models.fields.CharField')(max_length=80)),
            ('close_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
        ))
        db.send_create_signal(u'activity', ['CloseEasterRecord'])


    def backwards(self, orm):
        # Deleting model 'CloseEasterRecord'
        db.delete_table(u'activity_closeeasterrecord')
