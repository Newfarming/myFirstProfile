...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EggRecord.user_need'
        db.add_column(u'activity_eggrecord', 'user_need',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EggRecord.user_need'
        db.delete_column(u'activity_eggrecord', 'user_need')
