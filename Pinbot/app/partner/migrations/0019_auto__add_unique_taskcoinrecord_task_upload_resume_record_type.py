...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'TaskCoinRecord', fields ['task', 'upload_resume', 'record_type']
        db.create_unique(u'partner_taskcoinrecord', ['task_id', 'upload_resume_id', 'record_type'])


    def backwards(self, orm):
        # Removing unique constraint on 'TaskCoinRecord', fields ['task', 'upload_resume', 'record_type']
        db.delete_unique(u'partner_taskcoinrecord', ['task_id', 'upload_resume_id', 'record_type'])
    ...
    models = {
        ...
        'feed.feed': {
            ...
            'feed_expire_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 7, 0, 0)', 'db_index': 'True'}),
        ...
        u'jobs.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 29, 0, 0)'}),
