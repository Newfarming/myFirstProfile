...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FollowTaskRecord.check_time'
        db.add_column(u'partner_followtaskrecord', 'check_time',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2015, 6, 26, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FollowTaskRecord.check_time'
        db.delete_column(u'partner_followtaskrecord', 'check_time')
