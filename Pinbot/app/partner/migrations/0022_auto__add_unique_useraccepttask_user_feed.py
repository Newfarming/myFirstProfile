...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'UserAcceptTask', fields ['user', 'feed']
        db.create_unique(u'partner_useraccepttask', ['user_id', 'feed_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserAcceptTask', fields ['user', 'feed']
        db.delete_unique(u'partner_useraccepttask', ['user_id', 'feed_id'])
    ...
    models = {
        ...
        'feed.feed': {
            ...
            'feed_expire_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 24, 0, 0)', 'db_index': 'True'}),
