...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserTaskResume.verify'
        db.add_column(u'partner_usertaskresume', 'verify',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserTaskResume.verify'
        db.delete_column(u'partner_usertaskresume', 'verify')
