...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ResumeProject'
        db.create_table(u'partner_resumeproject', (
            ...
            ('resume', self.gf('django.db.models.fields.related.ForeignKey')(related_name='resume_projects', to=orm['partner.UploadResume'])),
        ))
        db.send_create_signal(u'partner', ['ResumeProject'])
        ...
        # Adding model 'TaskCoinRecord'
        db.create_table(u'partner_taskcoinrecord', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='task_coins', to=orm['auth.User'])),
            ('task', self.gf('django.db.models.fields.related.ForeignKey')(related_name='task_coin_records', to=orm['partner.UserAcceptTask'])),
            ('upload_resume', self.gf('django.db.models.fields.related.ForeignKey')(related_name='resume_coin_records', to=orm['partner.UploadResume'])),
            ('coin', self.gf('django.db.models.fields.FloatField')()),
        ...
        db.send_create_signal(u'partner', ['TaskCoinRecord'])

        # Adding model 'ResumeSkill'
        db.create_table(u'partner_resumeskill', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('resume', self.gf('django.db.models.fields.related.ForeignKey')(related_name='resume_skills', to=orm['partner.UploadResume'])),
        ))
        db.send_create_signal(u'partner', ['ResumeSkill'])

        # Adding model 'ResumeEducation'
        db.create_table(u'partner_resumeeducation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('start_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('end_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ...
            ('resume', self.gf('django.db.models.fields.related.ForeignKey')(related_name='resume_educations', to=orm['partner.UploadResume'])),
        ))
        db.send_create_signal(u'partner', ['ResumeEducation'])

        # Adding field 'UploadResume.expect_work_place'
        db.add_column(u'partner_uploadresume', 'expect_work_place',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)

        # Adding field 'UploadResume.expect_position'
        db.add_column(u'partner_uploadresume', 'expect_position',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=80, blank=True),
                      keep_default=False)

        # Adding field 'UploadResume.expect_salary_min'
        db.add_column(u'partner_uploadresume', 'expect_salary_min',
                      self.gf('django.db.models.fields.FloatField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'UploadResume.last_contact'
        db.add_column(u'partner_uploadresume', 'last_contact',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'UploadResume.hr_evaluate'
        db.add_column(u'partner_uploadresume', 'hr_evaluate',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ResumeProject'
        db.delete_table(u'partner_resumeproject')

        # Deleting model 'ResumeWorks'
        db.delete_table(u'partner_resumeworks')

        # Deleting model 'TaskCoinRecord'
        db.delete_table(u'partner_taskcoinrecord')

        # Deleting model 'ResumeSkill'
        db.delete_table(u'partner_resumeskill')

        # Deleting model 'ResumeEducation'
        db.delete_table(u'partner_resumeeducation')

        # Deleting field 'UploadResume.expect_work_place'
        db.delete_column(u'partner_uploadresume', 'expect_work_place')

        # Deleting field 'UploadResume.expect_position'
        db.delete_column(u'partner_uploadresume', 'expect_position')

        # Deleting field 'UploadResume.expect_salary_min'
        db.delete_column(u'partner_uploadresume', 'expect_salary_min')

        # Deleting field 'UploadResume.last_contact'
        db.delete_column(u'partner_uploadresume', 'last_contact')

        # Deleting field 'UploadResume.hr_evaluate'
        db.delete_column(u'partner_uploadresume', 'hr_evaluate')
    ...
    models = {
        ...
        u'partner.resumeworks': {
            'Meta': {'object_name': 'ResumeWorks'},
