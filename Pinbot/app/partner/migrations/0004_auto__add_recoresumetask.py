...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RecoResumeTask'
        db.create_table(u'partner_recoresumetask', (
            ...
            ('upload_resume', self.gf('django.db.models.fields.related.ForeignKey')(related_name='reco_resume_tasks', to=orm['partner.UploadResume'])),
        ))
        db.send_create_signal(u'partner', ['RecoResumeTask'])


    def backwards(self, orm):
        # Deleting model 'RecoResumeTask'
        db.delete_table(u'partner_recoresumetask')
    ...
    models = {
        ...
        'feed.feed': {
            ...
            'delete_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 20, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'feed_expire_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 28, 0, 0)'}),
            ...
            'last_click_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 20, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'jobs.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 20, 0, 0)'}),
