...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'UserTaskResume', fields ['task', 'resume']
        db.create_unique(u'partner_usertaskresume', ['task_id', 'resume_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserTaskResume', fields ['task', 'resume']
        db.delete_unique(u'partner_usertaskresume', ['task_id', 'resume_id'])
    ...
    models = {
        ...
        'feed.feed': {
            ...
            'feed_expire_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 29, 0, 0)', 'db_index': 'True'}),
        ...
        u'jobs.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 21, 0, 0)'}),
