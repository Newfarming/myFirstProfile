...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserTaskResume.extra_grant'
        db.add_column(u'partner_usertaskresume', 'extra_grant',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserTaskResume.extra_grant'
        db.delete_column(u'partner_usertaskresume', 'extra_grant')
    ...
    models = {
        ...
        'feed.feed': {
            ...
            'feed_expire_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 23, 0, 0)', 'db_index': 'True'}),
        ...
        u'jobs.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 15, 0, 0)'}),
