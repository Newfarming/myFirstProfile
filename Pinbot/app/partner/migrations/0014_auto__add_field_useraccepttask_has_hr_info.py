...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserAcceptTask.has_hr_info'
        db.add_column(u'partner_useraccepttask', 'has_hr_info',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserAcceptTask.has_hr_info'
        db.delete_column(u'partner_useraccepttask', 'has_hr_info')
    ...
    models = {
        ...
        'feed.feed': {
            ...
            'delete_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 16, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'feed_expire_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 24, 0, 0)'}),
            ...
            'last_click_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 16, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'jobs.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 16, 0, 0)'}),
