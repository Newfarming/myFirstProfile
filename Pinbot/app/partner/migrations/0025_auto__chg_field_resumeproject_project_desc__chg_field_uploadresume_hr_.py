...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ResumeProject.project_desc'
        db.alter_column(u'partner_resumeproject', 'project_desc', self.gf('django.db.models.fields.CharField')(max_length=3000))

        # Changing field 'UploadResume.hr_evaluate'
        db.alter_column(u'partner_uploadresume', 'hr_evaluate', self.gf('django.db.models.fields.CharField')(max_length=500))

        # Changing field 'UploadResume.self_evaluation'
        db.alter_column(u'partner_uploadresume', 'self_evaluation', self.gf('django.db.models.fields.CharField')(max_length=3000))

    def backwards(self, orm):

        # Changing field 'ResumeProject.project_desc'
        db.alter_column(u'partner_resumeproject', 'project_desc', self.gf('django.db.models.fields.CharField')(max_length=500))

        # Changing field 'UploadResume.hr_evaluate'
        db.alter_column(u'partner_uploadresume', 'hr_evaluate', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'UploadResume.self_evaluation'
        db.alter_column(u'partner_uploadresume', 'self_evaluation', self.gf('django.db.models.fields.CharField')(max_length=400))
    ...
    models = {
        ...
        'feed.feed': {
            ...
            'feed_expire_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 22, 0, 0)', 'db_index': 'True'}),
        ...
        u'jobs.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 14, 0, 0)'}),
        ...
        u'partner.followtaskrecord': {
            'Meta': {'object_name': 'FollowTaskRecord'},
            'check_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'desc': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200'}),
            'follow_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'follow_type': ('django.db.models.fields.IntegerField', [], {}),
            'has_check': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'task_resume': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'follow_records'", 'to': u"orm['partner.UserTaskResume']"})
        },
        u'partner.hottasksetting': {
            'Meta': {'object_name': 'HotTaskSetting'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '40'})
        },
        u'partner.partnerlevelmanage': {
            'Meta': {'object_name': 'PartnerLevelManage'},
            'bonus_coin': ('django.db.models.fields.IntegerField', [], {}),
            'exp': ('django.db.models.fields.IntegerField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_max_level': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'level': ('django.db.models.fields.IntegerField', [], {}),
            'level_type': ('django.db.models.fields.IntegerField', [], {}),
            'next_bonus_coin': ('django.db.models.fields.IntegerField', [], {}),
            'next_exp': ('django.db.models.fields.IntegerField', [], {}),
            'next_level': ('django.db.models.fields.IntegerField', [], {}),
            'next_ratio': ('django.db.models.fields.FloatField', [], {'default': '0'}),
        ...
        u'partner.resumeproject': {
            ...
            'project_desc': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '3000'}),
        ...
        u'partner.taskcoinrecord': {
            'Meta': {'unique_together': "(('task', 'upload_resume', 'record_type'),)", 'object_name': 'TaskCoinRecord'},
        ...
        u'partner.uploadresume': {
            ...
            'hr_evaluate': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '500', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'resume_id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '50'}),
            ...
            'self_evaluation': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '3000'}),
        ...
        u'partner.useraccepttask': {
            'Meta': {'unique_together': "(('user', 'feed'),)", 'object_name': 'UserAcceptTask'},
            'accept_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'feed': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['feed.Feed']"}),
            'has_hr_info': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'task_id': ('django.db.models.fields.CharField', [], {'max_length': '30', 'db_index': 'True'}),
            'update_time': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'db_index': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'partner.userlevelstate': {
            'Meta': {'object_name': 'UserLevelState', 'db_table': "'partner_user_level_state'", 'managed': 'False'},
            'check_count': ('django.db.models.fields.IntegerField', [], {}),
            'download_count': ('django.db.models.fields.IntegerField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'interview_count': ('django.db.models.fields.IntegerField', [], {}),
            'taking_work_count': ('django.db.models.fields.IntegerField', [], {}),
            'username': ('django.db.models.fields.CharField', [], {'max_length': '60'})
        },
        u'partner.usertaskresume': {
            'Meta': {'unique_together': "(('task', 'resume'),)", 'object_name': 'UserTaskResume'},
            'accusation_reason': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200'}),
            'extra_grant': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'resume': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'resume_tasks'", 'to': u"orm['partner.UploadResume']"}),
            'resume_status': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
