...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaskCoinRecord.record_type'
        db.add_column(u'partner_taskcoinrecord', 'record_type',
                      self.gf('django.db.models.fields.CharField')(default='check_resume', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TaskCoinRecord.record_type'
        db.delete_column(u'partner_taskcoinrecord', 'record_type')
