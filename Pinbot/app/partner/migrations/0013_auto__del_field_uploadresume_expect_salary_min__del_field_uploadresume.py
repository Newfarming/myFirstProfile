...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'UploadResume.expect_salary_max'
        db.delete_column(u'partner_uploadresume', 'expect_salary_max')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'UploadResume.expect_salary_max'
        db.add_column(u'partner_uploadresume', 'expect_salary_max',
                      self.gf('django.db.models.fields.FloatField')(default=0, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'feed.feed': {
            ...
            'delete_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 5, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'feed_expire_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 13, 0, 0)'}),
            ...
            'last_click_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 5, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'jobs.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 5, 0, 0)'}),
