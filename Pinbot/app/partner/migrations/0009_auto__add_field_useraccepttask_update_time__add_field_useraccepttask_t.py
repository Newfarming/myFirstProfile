...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserAcceptTask.update_time'
        db.add_column(u'partner_useraccepttask', 'update_time',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2015, 6, 2, 0, 0), db_index=True, blank=True),
                      keep_default=False)

        # Adding field 'UserAcceptTask.task_id'
        db.add_column(u'partner_useraccepttask', 'task_id',
                      self.gf('django.db.models.fields.CharField')(default='556d493b8230db674659a306', max_length=30, db_index=True),
                      keep_default=False)

        # Adding field 'UserTaskResume.resume_status'
        db.add_column(u'partner_usertaskresume', 'resume_status',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserAcceptTask.update_time'
        db.delete_column(u'partner_useraccepttask', 'update_time')

        # Deleting field 'UserAcceptTask.task_id'
        db.delete_column(u'partner_useraccepttask', 'task_id')

        # Deleting field 'UserTaskResume.resume_status'
        db.delete_column(u'partner_usertaskresume', 'resume_status')
    ...
    models = {
        ...
        'feed.feed': {
            ...
            'delete_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 2, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'feed_expire_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 10, 0, 0)'}),
            ...
            'last_click_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 2, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'jobs.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 2, 0, 0)'}),
        ...
        u'partner.uploadresume': {
            ...
            'expect_salary_max': ('django.db.models.fields.FloatField', [], {'default': '0', 'blank': 'True'}),
