...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UploadTaskSetting'
        db.create_table(u'partner_uploadtasksetting', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='task_setting', unique=True, to=orm['auth.User'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'partner', ['UploadTaskSetting'])

        # Adding M2M table for field job_domains on 'UploadTaskSetting'
        m2m_table_name = db.shorten_name(u'partner_uploadtasksetting_job_domains')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('uploadtasksetting', models.ForeignKey(orm[u'partner.uploadtasksetting'], null=False)),
            ('companycategory', models.ForeignKey(orm[u'jobs.companycategory'], null=False))
        ))
        db.create_unique(m2m_table_name, ['uploadtasksetting_id', 'companycategory_id'])

        # Adding M2M table for field citys on 'UploadTaskSetting'
        m2m_table_name = db.shorten_name(u'partner_uploadtasksetting_citys')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('uploadtasksetting', models.ForeignKey(orm[u'partner.uploadtasksetting'], null=False)),
            ('city', models.ForeignKey(orm[u'system.city'], null=False))
        ))
        db.create_unique(m2m_table_name, ['uploadtasksetting_id', 'city_id'])


    def backwards(self, orm):
        # Deleting model 'UploadTaskSetting'
        db.delete_table(u'partner_uploadtasksetting')

        # Removing M2M table for field job_domains on 'UploadTaskSetting'
        db.delete_table(db.shorten_name(u'partner_uploadtasksetting_job_domains'))

        # Removing M2M table for field citys on 'UploadTaskSetting'
        db.delete_table(db.shorten_name(u'partner_uploadtasksetting_citys'))
