...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UploadTaskSetting.task_time'
        db.add_column(u'partner_uploadtasksetting', 'task_time',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UploadTaskSetting.task_time'
        db.delete_column(u'partner_uploadtasksetting', 'task_time')
