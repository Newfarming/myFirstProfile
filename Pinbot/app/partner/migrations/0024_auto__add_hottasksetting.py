...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HotTaskSetting'
        db.create_table(u'partner_hottasksetting', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=40)),
        ))
        db.send_create_signal(u'partner', ['HotTaskSetting'])


    def backwards(self, orm):
        # Deleting model 'HotTaskSetting'
        db.delete_table(u'partner_hottasksetting')
    ...
    models = {
        ...
        'feed.feed': {
            ...
            'feed_expire_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 1, 0, 0)', 'db_index': 'True'}),
        ...
        u'jobs.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 24, 0, 0)'}),
