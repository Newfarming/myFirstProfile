...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FollowTaskRecord'
        db.create_table(u'partner_followtaskrecord', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('task_resume', self.gf('django.db.models.fields.related.ForeignKey')(related_name='follow_records', to=orm['partner.UserTaskResume'])),
            ('follow_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('follow_type', self.gf('django.db.models.fields.IntegerField')()),
            ('desc', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('has_check', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'partner', ['FollowTaskRecord'])


    def backwards(self, orm):
        # Deleting model 'FollowTaskRecord'
        db.delete_table(u'partner_followtaskrecord')
    ...
    models = {
        ...
        'feed.feed': {
            ...
            'feed_expire_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 4, 0, 0)', 'db_index': 'True'}),
