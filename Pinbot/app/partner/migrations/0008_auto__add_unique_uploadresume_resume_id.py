...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'UploadResume', fields ['resume_id']
        db.create_unique(u'partner_uploadresume', ['resume_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'UploadResume', fields ['resume_id']
        db.delete_unique(u'partner_uploadresume', ['resume_id'])
    ...
    models = {
        ...
        'feed.feed': {
            ...
            'delete_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 1, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'feed_expire_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 9, 0, 0)'}),
            ...
            'last_click_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 1, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
