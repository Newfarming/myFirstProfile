...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PartnerLevelManage'
        db.create_table(u'partner_partnerlevelmanage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('level_type', self.gf('django.db.models.fields.IntegerField')()),
            ('exp', self.gf('django.db.models.fields.IntegerField')()),
            ('bonus_coin', self.gf('django.db.models.fields.IntegerField')()),
            ('level', self.gf('django.db.models.fields.IntegerField')()),
            ('ratio', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('next_level', self.gf('django.db.models.fields.IntegerField')()),
            ('next_exp', self.gf('django.db.models.fields.IntegerField')()),
            ('next_ratio', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('next_bonus_coin', self.gf('django.db.models.fields.IntegerField')()),
            ('is_max_level', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'partner', ['PartnerLevelManage'])


    def backwards(self, orm):
        # Deleting model 'PartnerLevelManage'
        db.delete_table(u'partner_partnerlevelmanage')
    ...
    models = {
        ...
        'feed.feed': {
            ...
            'feed_expire_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 16, 0, 0)', 'db_index': 'True'}),
        ...
        u'jobs.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 8, 0, 0)'}),
