...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TaskCoinRecord.user'
        db.delete_column(u'partner_taskcoinrecord', 'user_id')


    def backwards(self, orm):
        # Adding field 'TaskCoinRecord.user'
        db.add_column(u'partner_taskcoinrecord', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='task_coins', to=orm['auth.User']),
                      keep_default=False)
    ...
    models = {
        ...
        'feed.feed': {
            ...
            'delete_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 4, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'feed_expire_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 12, 0, 0)'}),
            ...
            'last_click_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 4, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
