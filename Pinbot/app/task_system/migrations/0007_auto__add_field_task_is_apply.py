...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.is_apply'
        db.add_column(u'task_system_task', 'is_apply',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.is_apply'
        db.delete_column(u'task_system_task', 'is_apply')
    ...
    models = {
        ...
        u'task_system.coupon': {
            ...
            'coupon_due_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 4, 8, 0, 0)'}),
        ...
        u'task_system.task': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_apply': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
