...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'TaskFinishedStatus', fields ['reward_time']
        db.create_index(u'task_system_taskfinishedstatus', ['reward_time'])


    def backwards(self, orm):
        # Removing index on 'TaskFinishedStatus', fields ['reward_time']
        db.delete_index(u'task_system_taskfinishedstatus', ['reward_time'])
