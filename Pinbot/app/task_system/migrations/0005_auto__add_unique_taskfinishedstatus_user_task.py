...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'TaskFinishedStatus', fields ['user', 'task']
        db.create_unique(u'task_system_taskfinishedstatus', ['user_id', 'task_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'TaskFinishedStatus', fields ['user', 'task']
        db.delete_unique(u'task_system_taskfinishedstatus', ['user_id', 'task_id'])
