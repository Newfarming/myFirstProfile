...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaskFinishedStatus.repeat_times'
        db.add_column(u'task_system_taskfinishedstatus', 'repeat_times',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TaskFinishedStatus.repeat_times'
        db.delete_column(u'task_system_taskfinishedstatus', 'repeat_times')
    ...
    models = {
        ...
        u'task_system.coupon': {
            ...
            'coupon_due_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 3, 16, 0, 0)'}),
        ...
        u'task_system.taskfinishedstatus': {
            'Meta': {'unique_together': "(('user', 'task'),)", 'object_name': 'TaskFinishedStatus'},
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'repeat_times': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
