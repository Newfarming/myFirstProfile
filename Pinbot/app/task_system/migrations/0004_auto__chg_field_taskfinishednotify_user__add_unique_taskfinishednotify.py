...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TaskFinishedNotify.user'
        db.alter_column(u'task_system_taskfinishednotify', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['auth.User']))
        # Adding unique constraint on 'TaskFinishedNotify', fields ['user']
        db.create_unique(u'task_system_taskfinishednotify', ['user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'TaskFinishedNotify', fields ['user']
        db.delete_unique(u'task_system_taskfinishednotify', ['user_id'])


        # Changing field 'TaskFinishedNotify.user'
        db.alter_column(u'task_system_taskfinishednotify', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    models = {
        ...
        u'task_system.coupon': {
            ...
            'coupon_due_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 27, 0, 0)'}),
        ...
        u'task_system.taskfinishednotify': {
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'notify_user'", 'unique': 'True', 'to': u"orm['auth.User']"})
        },
        u'task_system.taskfinishedstatus': {
            ...
            'reward_time': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
