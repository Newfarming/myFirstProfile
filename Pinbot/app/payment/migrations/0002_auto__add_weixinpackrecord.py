...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WeixinPackRecord'
        db.create_table(u'payment_weixinpackrecord', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['weixin.WeixinUser'])),
            ...
            ('send_status', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('send_msg', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'payment', ['WeixinPackRecord'])


    def backwards(self, orm):
        # Deleting model 'WeixinPackRecord'
        db.delete_table(u'payment_weixinpackrecord')
    ...
    models = {
        ...
        u'payment.weixinpackrecord': {
            'Meta': {'object_name': 'WeixinPackRecord'},
            'amount': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'send_msg': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'send_status': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'send_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['weixin.WeixinUser']"})
        },
