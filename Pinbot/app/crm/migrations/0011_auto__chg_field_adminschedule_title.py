...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AdminSchedule.title'
        db.alter_column(u'crm_adminschedule', 'title', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'AdminSchedule.title'
        db.alter_column(u'crm_adminschedule', 'title', self.gf('django.db.models.fields.CharField')(max_length=30))
    ...
    models = {
        ...
        'feed.feed': {
            ...
            'feed_expire_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 2, 5, 0, 0)', 'db_index': 'True'}),
        ...
        u'jobs.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 28, 0, 0)'}),
        ...
        u'jobs.sendcompanycard': {
            ...
            'feedback_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 28, 0, 0)'}),
            ...
            'send_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 28, 0, 0)'}),
        ...
        u'resumes.contactinfodata': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 28, 0, 0)', 'null': 'True', 'blank': 'True'}),
