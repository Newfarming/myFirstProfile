...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CRMFeedRemark'
        db.create_table(u'crm_crmfeedremark', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('feed', self.gf('django.db.models.fields.related.ForeignKey')(related_name='crm_remarks', to=orm['feed.Feed'])),
            ('admin', self.gf('django.db.models.fields.related.ForeignKey')(related_name='crm_feed_remarks', to=orm['auth.User'])),
        ...
        db.send_create_signal(u'crm', ['CRMFeedRemark'])

        # Adding model 'CRMClientInfo'
        db.create_table(u'crm_crmclientinfo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('client', self.gf('django.db.models.fields.related.OneToOneField')(related_name='crm_info', unique=True, to=orm['auth.User'])),
            ('admin', self.gf('django.db.models.fields.related.ForeignKey')(related_name='crm_clients', to=orm['auth.User'])),
            ('last_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('create_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'crm', ['CRMClientInfo'])

        # Adding model 'CRMDownloadResume'
        db.create_table(u'crm_crmdownloadresume', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('buy_resume', self.gf('django.db.models.fields.related.OneToOneField')(related_name='crm_resume_info', unique=True, to=orm['transaction.ResumeBuyRecord'])),
            ('admin', self.gf('django.db.models.fields.related.ForeignKey')(related_name='crm_download_resumes', to=orm['auth.User'])),
            ('create_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('update_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'crm', ['CRMDownloadResume'])


    def backwards(self, orm):
        # Deleting model 'CRMFeedRemark'
        db.delete_table(u'crm_crmfeedremark')

        # Deleting model 'CRMClientInfo'
        db.delete_table(u'crm_crmclientinfo')

        # Deleting model 'CRMDownloadResume'
        db.delete_table(u'crm_crmdownloadresume')
    ...
    models = {
        ...
        u'crm.crmclientinfo': {
            ...
            'admin': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'crm_clients'", 'to': u"orm['auth.User']"}),
            'client': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'crm_info'", 'unique': 'True', 'to': u"orm['auth.User']"}),
        ...
        'feed.feed': {
            ...
            'feed_expire_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 10, 30, 0, 0)', 'db_index': 'True'}),
        ...
        u'jobs.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 10, 22, 0, 0)'}),
        ...
        u'jobs.sendcompanycard': {
            ...
            'feedback_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 10, 22, 0, 0)'}),
            ...
            'send_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 10, 22, 0, 0)'}),
        ...
        u'resumes.contactinfodata': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 10, 22, 0, 0)', 'null': 'True', 'blank': 'True'}),
