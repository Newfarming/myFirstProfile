...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AdminSchedule'
        db.create_table(u'crm_adminschedule', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='schedule_user', to=orm['auth.User'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('start_time', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('backgroundcolor', self.gf('django.db.models.fields.CharField')(max_length=15)),
        ))
        db.send_create_signal(u'crm', ['AdminSchedule'])


    def backwards(self, orm):
        # Deleting model 'AdminSchedule'
        db.delete_table(u'crm_adminschedule')
    ...
    models = {
        ...
        u'crm.adminschedule': {
            'Meta': {'object_name': 'AdminSchedule'},
            'backgroundcolor': ('django.db.models.fields.CharField', [], {'max_length': '15'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'start_time': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'schedule_user'", 'to': u"orm['auth.User']"})
        },
        u'crm.candidate': {
        ...
        'feed.feed': {
            ...
            'feed_expire_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 2, 3, 0, 0)', 'db_index': 'True'}),
        ...
        u'jobs.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 26, 0, 0)'}),
        ...
        u'jobs.sendcompanycard': {
            ...
            'feedback_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 26, 0, 0)'}),
            ...
            'send_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 26, 0, 0)'}),
