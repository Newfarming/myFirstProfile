...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CandidateTag'
        db.create_table(u'crm_candidatetag', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal(u'crm', ['CandidateTag'])

        # Adding model 'Candidate'
        db.create_table(u'crm_candidate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('contact_info', self.gf('django.db.models.fields.related.OneToOneField')(related_name='candidate', unique=True, to=orm['resumes.ContactInfoData'])),
            ('admin', self.gf('django.db.models.fields.related.ForeignKey')(related_name='candidates', to=orm['auth.User'])),
            ('has_contact', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'crm', ['Candidate'])

        # Adding M2M table for field tags on 'Candidate'
        m2m_table_name = db.shorten_name(u'crm_candidate_tags')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('candidate', models.ForeignKey(orm[u'crm.candidate'], null=False)),
            ('candidatetag', models.ForeignKey(orm[u'crm.candidatetag'], null=False))
        ))
        db.create_unique(m2m_table_name, ['candidate_id', 'candidatetag_id'])

        # Adding model 'CandidateRemark'
        db.create_table(u'crm_candidateremark', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('candidate', self.gf('django.db.models.fields.related.ForeignKey')(related_name='candidate_remarks', to=orm['crm.Candidate'])),
            ('remark_type', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('desc', self.gf('django.db.models.fields.CharField')(max_length=150)),
            ('remark_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('admin', self.gf('django.db.models.fields.related.ForeignKey')(related_name='candidate_remark', to=orm['auth.User'])),
        ))
        db.send_create_signal(u'crm', ['CandidateRemark'])

        # Adding model 'CompanyCardSendRecord'
        db.create_table(u'crm_companycardsendrecord', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('job', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['feed.Feed'])),
            ('candidate', self.gf('django.db.models.fields.related.ForeignKey')(related_name='send_records', to=orm['crm.Candidate'])),
        ...
        db.send_create_signal(u'crm', ['CompanyCardSendRecord'])


    def backwards(self, orm):
        # Deleting model 'CandidateTag'
        db.delete_table(u'crm_candidatetag')

        # Deleting model 'Candidate'
        db.delete_table(u'crm_candidate')

        # Removing M2M table for field tags on 'Candidate'
        db.delete_table(db.shorten_name(u'crm_candidate_tags'))

        # Deleting model 'CandidateRemark'
        db.delete_table(u'crm_candidateremark')

        # Deleting model 'CompanyCardSendRecord'
        db.delete_table(u'crm_companycardsendrecord')
    ...
    models = {
        ...
        u'crm.candidate': {
            ...
            'admin': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'candidates'", 'to': u"orm['auth.User']"}),
        ...
        'feed.feed': {
            ...
            'feed_expire_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 6, 0, 0)', 'db_index': 'True'}),
        ...
        u'jobs.company': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 29, 0, 0)'}),
        ...
        u'resumes.contactinfodata': {
            ...
            'add_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 29, 0, 0)', 'null': 'True', 'blank': 'True'}),
