...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserDailyReportData.total_active_user_count'
        db.delete_column(u'dash_userdailyreportdata', 'total_active_user_count')

        # Deleting field 'UserDailyReportData.total_vip_user_count'
        db.delete_column(u'dash_userdailyreportdata', 'total_vip_user_count')

        # Deleting field 'UserDailyReportData.total_normal_user_count'
        db.delete_column(u'dash_userdailyreportdata', 'total_normal_user_count')

        # Deleting field 'UserDailyReportData.new_vip_user_count'
        db.delete_column(u'dash_userdailyreportdata', 'new_vip_user_count')

        # Deleting field 'UserDailyReportData.new_normal_user_count'
        db.delete_column(u'dash_userdailyreportdata', 'new_normal_user_count')

        # Adding field 'UserDailyReportData.new_experience_user_count'
        db.add_column(u'dash_userdailyreportdata', 'new_experience_user_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'UserDailyReportData.new_self_member_count'
        db.add_column(u'dash_userdailyreportdata', 'new_self_member_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
        ...
        # Adding field 'UserDailyReportData.new_manual_member_count'
        db.add_column(u'dash_userdailyreportdata', 'new_manual_member_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'UserDailyReportData.total_experience_user_count'
        db.add_column(u'dash_userdailyreportdata', 'total_experience_user_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'UserDailyReportData.total_self_member_count'
        db.add_column(u'dash_userdailyreportdata', 'total_self_member_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
        ...
        # Adding field 'UserDailyReportData.total_manual_member_count'
        db.add_column(u'dash_userdailyreportdata', 'total_manual_member_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserDailyReportData.total_active_user_count'
        db.add_column(u'dash_userdailyreportdata', 'total_active_user_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'UserDailyReportData.total_vip_user_count'
        db.add_column(u'dash_userdailyreportdata', 'total_vip_user_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'UserDailyReportData.total_normal_user_count'
        db.add_column(u'dash_userdailyreportdata', 'total_normal_user_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'UserDailyReportData.new_vip_user_count'
        db.add_column(u'dash_userdailyreportdata', 'new_vip_user_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'UserDailyReportData.new_normal_user_count'
        db.add_column(u'dash_userdailyreportdata', 'new_normal_user_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'UserDailyReportData.new_experience_user_count'
        db.delete_column(u'dash_userdailyreportdata', 'new_experience_user_count')

        # Deleting field 'UserDailyReportData.new_self_member_count'
        db.delete_column(u'dash_userdailyreportdata', 'new_self_member_count')
        ...
        # Deleting field 'UserDailyReportData.new_manual_member_count'
        db.delete_column(u'dash_userdailyreportdata', 'new_manual_member_count')

        # Deleting field 'UserDailyReportData.total_experience_user_count'
        db.delete_column(u'dash_userdailyreportdata', 'total_experience_user_count')

        # Deleting field 'UserDailyReportData.total_self_member_count'
        db.delete_column(u'dash_userdailyreportdata', 'total_self_member_count')
        ...
        # Deleting field 'UserDailyReportData.total_manual_member_count'
        db.delete_column(u'dash_userdailyreportdata', 'total_manual_member_count')
