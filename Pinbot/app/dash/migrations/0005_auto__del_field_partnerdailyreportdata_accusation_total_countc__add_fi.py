...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PartnerDailyReportData.accusation_total_countc'
        db.delete_column(u'dash_partnerdailyreportdata', 'accusation_total_countc')

        # Adding field 'PartnerDailyReportData.accusation_total_count'
        db.add_column(u'dash_partnerdailyreportdata', 'accusation_total_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PartnerDailyReportData.accusation_total_countc'
        db.add_column(u'dash_partnerdailyreportdata', 'accusation_total_countc',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'PartnerDailyReportData.accusation_total_count'
        db.delete_column(u'dash_partnerdailyreportdata', 'accusation_total_count')
