...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TaskSystemDailyReportData'
        db.create_table(u'dash_tasksystemdailyreportdata', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('report_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('task_A1_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('task_A2_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('task_A3_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('task_A4_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('task_A5_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('task_A6_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('task_A6_R1_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('task_A6_R2_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('task_A6_L1_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('task_A7_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('task_A7_R1_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('task_A7_R2_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('task_A7_R3_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('task_A8_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('task_A8_R1_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('task_A8_R2_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('task_A8_R3_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('task_A9_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('task_A9_R1_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('task_A9_R2_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('task_A9_R3_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('task_A10_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('task_A10_R1_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('task_A11_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('task_A12_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('task_A13_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('task_A14_L1_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('task_A15_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('task_A15_R1_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('task_A15_R2_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('task_A16_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('task_A17_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('task_A18_R1_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('task_A18_R2_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('dash', ['TaskSystemDailyReportData'])


    def backwards(self, orm):
        # Deleting model 'TaskSystemDailyReportData'
        db.delete_table(u'dash_tasksystemdailyreportdata')
