...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PartnerDailyReportData'
        db.create_table(u'dash_partnerdailyreportdata', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('accept_task_user_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('accept_task_user_total_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('task_total_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('task_viewed_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('task_accedpted_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('task_accedpted_total_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('commend_resume_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('commend_resume_total_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('do_task_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('do_task_total_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('resume_viewed_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('resume_viewed_total_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('resume_download_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('resume_download_total_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('interviewed_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('interviewed_total_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('entered_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('entered_total_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('accusation_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('accusation_total_countc', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('report_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'dash', ['PartnerDailyReportData'])


    def backwards(self, orm):
        # Deleting model 'PartnerDailyReportData'
        db.delete_table(u'dash_partnerdailyreportdata')
    ...
    models = {
        u'dash.partnerdailyreportdata': {
            ...
            'accusation_total_countc': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'commend_resume_count': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'commend_resume_total_count': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
