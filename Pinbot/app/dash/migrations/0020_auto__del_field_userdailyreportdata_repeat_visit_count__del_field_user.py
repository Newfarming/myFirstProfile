...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserDailyReportData.repeat_visit_count'
        db.delete_column(u'dash_userdailyreportdata', 'repeat_visit_count')

        # Deleting field 'UserDailyReportData.lively_user_count'
        db.delete_column(u'dash_userdailyreportdata', 'lively_user_count')


    def backwards(self, orm):
        # Adding field 'UserDailyReportData.repeat_visit_count'
        db.add_column(u'dash_userdailyreportdata', 'repeat_visit_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'UserDailyReportData.lively_user_count'
        db.add_column(u'dash_userdailyreportdata', 'lively_user_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
