...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CoreDailyReportData'
        db.create_table(u'dash_coredailyreportdata', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('active_user_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('self_service_member_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('manual_service_member_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('entry_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('lively_userr_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('lively_memberr_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ...
        db.send_create_signal(u'dash', ['CoreDailyReportData'])


    def backwards(self, orm):
        # Deleting model 'CoreDailyReportData'
        db.delete_table(u'dash_coredailyreportdata')
    ...
    models = {
        u'dash.coredailyreportdata': {
            ...
            'lively_userr_count': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'manual_service_member_count': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            ...
            'self_service_member_count': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
