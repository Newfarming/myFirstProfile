...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CoreDailyReportData.self_service_member_count'
        db.delete_column(u'dash_coredailyreportdata', 'self_service_member_count')

        # Deleting field 'CoreDailyReportData.manual_service_member_count'
        db.delete_column(u'dash_coredailyreportdata', 'manual_service_member_count')

        # Deleting field 'CoreDailyReportData.lively_userr_count'
        db.delete_column(u'dash_coredailyreportdata', 'lively_userr_count')

        # Adding field 'CoreDailyReportData.member_count'
        db.add_column(u'dash_coredailyreportdata', 'member_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'CoreDailyReportData.lively_user_count'
        db.add_column(u'dash_coredailyreportdata', 'lively_user_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'CoreDailyReportData.self_service_member_count'
        db.add_column(u'dash_coredailyreportdata', 'self_service_member_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'CoreDailyReportData.manual_service_member_count'
        db.add_column(u'dash_coredailyreportdata', 'manual_service_member_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'CoreDailyReportData.lively_userr_count'
        db.add_column(u'dash_coredailyreportdata', 'lively_userr_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'CoreDailyReportData.member_count'
        db.delete_column(u'dash_coredailyreportdata', 'member_count')

        # Deleting field 'CoreDailyReportData.lively_user_count'
        db.delete_column(u'dash_coredailyreportdata', 'lively_user_count')
    ...
    models = {
        u'dash.coredailyreportdata': {
            ...
            'lively_memberr_count': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
