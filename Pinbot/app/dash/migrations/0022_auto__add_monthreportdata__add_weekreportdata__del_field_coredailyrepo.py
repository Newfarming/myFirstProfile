...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MonthReportData'
        db.create_table(u'dash_monthreportdata', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('report_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('month_lively_user_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('month_lively_member_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('month_repeat_visit_user_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('month_repeat_visit_member_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('dash', ['MonthReportData'])

        # Adding model 'WeekReportData'
        db.create_table(u'dash_weekreportdata', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('report_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('week_lively_user_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('week_lively_member_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('week_repeat_visit_user_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('week_repeat_visit_member_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('dash', ['WeekReportData'])

        # Deleting field 'CoreDailyReportData.week_lively_user_count'
        db.delete_column(u'dash_coredailyreportdata', 'week_lively_user_count')

        # Deleting field 'CoreDailyReportData.month_lively_user_count'
        db.delete_column(u'dash_coredailyreportdata', 'month_lively_user_count')

        # Deleting field 'CoreDailyReportData.week_repeat_visit_member_count'
        db.delete_column(u'dash_coredailyreportdata', 'week_repeat_visit_member_count')

        # Deleting field 'CoreDailyReportData.month_repeat_visit_member_count'
        db.delete_column(u'dash_coredailyreportdata', 'month_repeat_visit_member_count')

        # Deleting field 'CoreDailyReportData.month_repeat_visit_user_count'
        db.delete_column(u'dash_coredailyreportdata', 'month_repeat_visit_user_count')

        # Deleting field 'CoreDailyReportData.month_lively_member_count'
        db.delete_column(u'dash_coredailyreportdata', 'month_lively_member_count')

        # Deleting field 'CoreDailyReportData.week_repeat_visit_user_count'
        db.delete_column(u'dash_coredailyreportdata', 'week_repeat_visit_user_count')

        # Deleting field 'CoreDailyReportData.week_lively_member_count'
        db.delete_column(u'dash_coredailyreportdata', 'week_lively_member_count')


    def backwards(self, orm):
        # Deleting model 'MonthReportData'
        db.delete_table(u'dash_monthreportdata')

        # Deleting model 'WeekReportData'
        db.delete_table(u'dash_weekreportdata')

        # Adding field 'CoreDailyReportData.week_lively_user_count'
        db.add_column(u'dash_coredailyreportdata', 'week_lively_user_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'CoreDailyReportData.month_lively_user_count'
        db.add_column(u'dash_coredailyreportdata', 'month_lively_user_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'CoreDailyReportData.week_repeat_visit_member_count'
        db.add_column(u'dash_coredailyreportdata', 'week_repeat_visit_member_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'CoreDailyReportData.month_repeat_visit_member_count'
        db.add_column(u'dash_coredailyreportdata', 'month_repeat_visit_member_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'CoreDailyReportData.month_repeat_visit_user_count'
        db.add_column(u'dash_coredailyreportdata', 'month_repeat_visit_user_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'CoreDailyReportData.month_lively_member_count'
        db.add_column(u'dash_coredailyreportdata', 'month_lively_member_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'CoreDailyReportData.week_repeat_visit_user_count'
        db.add_column(u'dash_coredailyreportdata', 'week_repeat_visit_user_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'CoreDailyReportData.week_lively_member_count'
        db.add_column(u'dash_coredailyreportdata', 'week_lively_member_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
