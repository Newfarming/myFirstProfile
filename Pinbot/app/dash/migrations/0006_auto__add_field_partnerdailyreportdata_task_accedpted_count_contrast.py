...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PartnerDailyReportData.task_accedpted_count_contrast'
        db.add_column(u'dash_partnerdailyreportdata', 'task_accedpted_count_contrast',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PartnerDailyReportData.task_accedpted_count_contrast'
        db.delete_column(u'dash_partnerdailyreportdata', 'task_accedpted_count_contrast')
    ...
    models = {
        u'dash.partnerdailyreportdata': {
            ...
            'task_accedpted_count_contrast': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
