...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PartnerDailyReportData.today_commend_and_check_count'
        db.add_column(u'dash_partnerdailyreportdata', 'today_commend_and_check_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'PartnerDailyReportData.today_commend_and_download_count'
        db.add_column(u'dash_partnerdailyreportdata', 'today_commend_and_download_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PartnerDailyReportData.today_commend_and_check_count'
        db.delete_column(u'dash_partnerdailyreportdata', 'today_commend_and_check_count')

        # Deleting field 'PartnerDailyReportData.today_commend_and_download_count'
        db.delete_column(u'dash_partnerdailyreportdata', 'today_commend_and_download_count')
