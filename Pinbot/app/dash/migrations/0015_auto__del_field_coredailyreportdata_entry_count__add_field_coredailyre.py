...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CoreDailyReportData.entry_count'
        db.delete_column(u'dash_coredailyreportdata', 'entry_count')
    ...
    def backwards(self, orm):
        # Adding field 'CoreDailyReportData.entry_count'
        db.add_column(u'dash_coredailyreportdata', 'entry_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
