...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PartnerDailyReportData.today_extra_reward_coin_count'
        db.add_column(u'dash_partnerdailyreportdata', 'today_extra_reward_coin_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'PartnerDailyReportData.all_extra_reward_coin_count'
        db.add_column(u'dash_partnerdailyreportdata', 'all_extra_reward_coin_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PartnerDailyReportData.today_extra_reward_coin_count'
        db.delete_column(u'dash_partnerdailyreportdata', 'today_extra_reward_coin_count')

        # Deleting field 'PartnerDailyReportData.all_extra_reward_coin_count'
        db.delete_column(u'dash_partnerdailyreportdata', 'all_extra_reward_coin_count')
