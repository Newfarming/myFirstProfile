...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PartnerDailyReportData.task_accedpted_count_contrast'
        db.alter_column(u'dash_partnerdailyreportdata', 'task_accedpted_count_contrast', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'PartnerDailyReportData.task_accedpted_count_contrast'
        db.alter_column(u'dash_partnerdailyreportdata', 'task_accedpted_count_contrast', self.gf('django.db.models.fields.IntegerField')())
