...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ResumeDailyReportData.resume_down_proportion'
        db.alter_column(u'dash_resumedailyreportdata', 'resume_down_proportion', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'ResumeDailyReportData.resume_down_proportion'
        db.alter_column(u'dash_resumedailyreportdata', 'resume_down_proportion', self.gf('django.db.models.fields.IntegerField')())
